		...
		<div class="vbo-operator-tool-top-filters-inner">
			<form action="<?php echo $tool_uri; ?>" method="post">
				<div class="vbo-operator-tool-top-filter vbo-operator-tool-dt-filter">
					<label for="vbo-tool-finance-from-dt"><?php echo JText::_('VBOPROMORENTFROM'); ?></label>
					<?php echo $vbo_app->getCalendar($from_date, 'from_date', 'vbo-tool-finance-from-dt'); ?>
				</div>
				<div class="vbo-operator-tool-top-filter vbo-operator-tool-dt-filter">
					<label for="vbo-tool-finance-to-dt"><?php echo JText::_('VBOPROMORENTTO'); ?></label>
				...
				<div class="vbo-operator-tool-top-filter vbo-operator-tool-submit-filter">
					<button type="submit" class="btn btn-primary vbo-pref-color-btn"><?php echo JText::_('VBSEARCHBUTTON'); ?></button>
				</div>
			</form>
			<div class="vbo-operator-tool-listings">
				<span><?php echo $listing_names ? JText::sprintf('VBO_LISTING_NAMES', implode(', ', $listing_names)) : JText::_('VBO_ALL_LISTINGS'); ?></span>
			</div>
		</div>
	</div>
	<div class="vbo-operator-tool-finance-stats">
		...
		<div class="vbo-tool-finance-data-blocks">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="gross_revenue">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBO_GROSS_BOOKING_VALUE'); ?></span>
					</div>
			...
			<div class="vbo-tool-finance-data-block" data-typestat="taxes">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBOINVCOLTAX'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="cmms">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBTOTALCOMMISSIONS'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="revenue">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBOREPORTREVENUE'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="ibe_revenue">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBOREPORTREVENUEREVWEB'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="ota_revenue">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBOREPORTREVENUEREVOTA'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
		...
		if ($stats['cmm_savings'] > 0) {
			...
			<div class="vbo-tool-finance-data-block" data-typestat="ota_avg_cmms">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBO_AVG_COMMISSIONS'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="cmm_savings">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBO_COMMISSION_SAVINGS'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
		...
		?>
			...
			<div class="vbo-tool-finance-data-block" data-typestat="tot_bookings">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBCUSTOMERTOTBOOKINGS'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
						<span class="vbo-tool-finance-stat-amount-value">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="nights_booked">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBOGRAPHTOTNIGHTSLBL'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
						<span class="vbo-tool-finance-stat-amount-value vbo-tooltip vbo-tooltip-top" data-tooltiptext="<?php echo htmlspecialchars(trim(str_replace('%', '', JText::_('VBOREPORTREVENUEPOCC'))) . ' ' . $stats['occupancy'] . '%'); ?>">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="avg_los">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBTRKAVGLOS'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
						<span class="vbo-tool-finance-stat-amount-value">
			...
			<div class="vbo-tool-finance-data-block" data-typestat="rooms_booked">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBLIBTEN'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-amount">
						<span class="vbo-tool-finance-stat-amount-value vbo-tooltip vbo-tooltip-top" data-tooltiptext="<?php echo htmlspecialchars(JText::_('VBOGRAPHTOTUNITSLBL') . ' ' . $stats['room_units']); ?>">
	...
	if (($stats['country_ranks'] ?? []) || ($stats['pos_revenue'] ?? [])) {
		...
		<div class="vbo-tool-finance-data-block-rankings">
			...
			<div class="vbo-tool-finance-data-block-rank" data-typestat="country_ranks">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBOSTATSTOPCOUNTRIES'); ?></span>
					</div>
			...
			<div class="vbo-tool-finance-data-block-rank" data-typestat="pos_revenue">
				<div class="vbo-tool-finance-stat">
					<div class="vbo-tool-finance-stat-info">
						<span class="vbo-tool-finance-stat-name"><?php echo JText::_('VBOCHANNELS'); ?></span>
					</div>
					<div class="vbo-tool-finance-stat-ranks">
					<?php
