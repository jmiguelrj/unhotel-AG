...
?>
<h3 class="vbo-booking-details-intro"><?php echo JText::_('VBOLEAVEAREVIEWSTAY'); ?></h3>
...
<div class="vbo-booking-leavereview-wrap">
	...
	<div class="vbo-booking-leavereview-content">
		<div class="vbo-booking-leavereview-inner">
			<form action="<?php echo JRoute::_('index.php?option=com_vikbooking&task=sendreview'); ?>" method="post" onsubmit="return vboValidateReview();">
				...
				foreach ($rev_services as $k => $v) {
					...
					if (isset($v['service_name']) && !empty($v['service_name'])) {
						...
						?>
						<h5 class="vbo-booking-review-servicename vbo-booking-review-global"><?php echo JText::_('VBOREVIEWRATEEXP'); ?></h5>
						<?php
					}
					?>
				...
				<div class="vbo-booking-review-message">
					<label for="vbo-review-message"><?php echo JText::_('VBOREVIEWLEAVEMESS'); ?></label>
					<div class="vbo-booking-review-message-inner">
						<textarea name="ratingmess" id="vbo-review-message"></textarea>
						<div class="vbo-booking-review-message-privacy"><?php echo JText::_('VBOREVIEWMESSPRIVACY'); ?></div>
					</div>
				</div>
					<?php
				}
