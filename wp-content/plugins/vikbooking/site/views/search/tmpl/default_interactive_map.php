	...
	if ($this->roomsnum > 1) {
		...
		<div class="vbo-geomap-uicontrol">
			<div class="vbo-geomap-uicontrol-inner">
				<span class="vbo-geomap-uicontrol-partynum"><?php echo JText::_('VBSEARCHROOMNUM'); ?> 1</span>
				<span class="vbo-geomap-uicontrol-partyguests">
					...
					<?php echo ($this->arrpeople[1]['adults'] == 1 ? JText::_('VBSEARCHRESADULT') : JText::_('VBSEARCHRESADULTS')); ?> 
					<?php echo ($this->showchildren && $this->arrpeople[1]['children'] > 0 ? ", ".$this->arrpeople[1]['children']." ".($this->arrpeople[1]['children'] == 1 ? JText::_('VBSEARCHRESCHILD') : JText::_('VBSEARCHRESCHILDREN')) : ""); ?>
				</span>
			</div>
		</div>
		<?php
