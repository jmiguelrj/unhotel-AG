...
<form action="<?php echo JRoute::_('index.php?option=com_vikbooking&task=storesignature'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" method="post" name="vbo_sign_form" id="vbo_sign_form">

	<div class="vbo-sign-bookdet-container">
		<div class="vbo-sign-bookdet-wrap">
			<div class="vbo-sign-bookdet-head">
				<span><?php echo JText::_('VBBOOKINGDATE'); ?></span>
			</div>
		...
		<div class="vbo-sign-bookdet-wrap">
			<div class="vbo-sign-bookdet-head">
				<span><?php echo JText::_('VBOCUSTOMERNOMINATIVE'); ?></span>
			</div>
			<div class="vbo-sign-bookdet-foot">
		...
		<div class="vbo-sign-bookdet-wrap">
			<div class="vbo-sign-bookdet-head">
				<span><?php echo JText::_('VBOROOMSBOOKED'); ?></span>
			</div>
			<div class="vbo-sign-bookdet-foot">
		...
		<div class="vbo-sign-bookdet-wrap">
			<div class="vbo-sign-bookdet-head">
				<span><?php echo JText::_('VBOSIGNATUREGUESTS'); ?></span>
			</div>
			<div class="vbo-sign-bookdet-foot">
				<?php echo ($tot_adults > 0 ? $tot_adults.' '.($tot_adults > 1 ? JText::_('VBSEARCHRESADULTS') : JText::_('VBSEARCHRESADULT')).($tot_children > 0 ? ', ' : '') : ''); ?>
				<?php echo ($tot_children > 0 ? $tot_children.' '.($tot_children > 1 ? JText::_('VBSEARCHRESCHILDREN') : JText::_('VBSEARCHRESCHILD')) : ''); ?>
			</div>
		</div>
		<div class="vbo-sign-bookdet-wrap">
			<div class="vbo-sign-bookdet-head">
				<span><?php echo JText::_('VBDAYS'); ?></span>
			</div>
			<div class="vbo-sign-bookdet-foot">
		...
		<div class="vbo-sign-bookdet-wrap">
			<div class="vbo-sign-bookdet-head">
				<span><?php echo JText::_('VBPICKUP'); ?></span>
			</div>
			<div class="vbo-sign-bookdet-foot">
			<?php
		...
		<div class="vbo-sign-bookdet-wrap">
			<div class="vbo-sign-bookdet-head">
				<span><?php echo JText::_('VBRETURN'); ?></span>
			</div>
			<div class="vbo-sign-bookdet-foot">
			<?php
			...
			<div class="vbo-signature-pad-footer">
				...
				<div class="vbo-signature-cmds">
					...
					<div class="vbo-signature-cmd">
						<button type="button" class="btn btn-large vbo-pref-color-btn" onclick="vboShowSignPad();"><i class="vboicn-quill"></i> <?php echo JText::_('VBOSIGNATUREAGAIN'); ?></button>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	if (!$empty_termsconds) {
		...
		?>
	vbo_overlay_data['termsconds'] = '<div><?php echo addslashes($termsconds); ?></div><div class="vbo-center"><br /><button type="button" class="btn btn-large vbo-pref-color-btn" onclick="jQuery(\'#termsconds\').prop(\'checked\', true);vboCloseModal();"><?php echo addslashes(JText::_('VBOTERMSCONDSACCCLOSE')); ?></button></div>';
		<?php
	}
	?>
</script>
