...
<div class="vbstepsbarcont">
	...
	if ($is_package === true) {
		...
		<li class="vbo-step vbo-step-complete"><a href="<?php echo JRoute::_('index.php?option=com_vikbooking&task=showprc&checkin='.$first.'&checkout='.$second.'&roomsnum='.$roomsnum.'&days='.$days.'&pkg_id='.$pkg['id'].$peopleforlink.$roomoptforlink.$roomindexlink.(!empty($pitemid) ? '&Itemid='.$pitemid : ''), false); ?>"><?php echo JText::_('VBSTEPOPTIONS'); ?></a></li>
		<?php
	} else {
		...
		if ($this->roomsnum < 2 && (int) $session->get('vboSearchRoomId', 0) == (int) $this->rooms[1]['id']) {
			...
			$dateslink = JRoute::_('index.php?option=com_vikbooking&view=roomdetails&roomid='.$this->rooms[1]['id'].'&checkin='.$first.'&checkout='.$second.(!empty($pitemid) ? '&Itemid='.$pitemid : ''));
		} else {
			// link to general search form
			$dateslink = JRoute::_('index.php?option=com_vikbooking&view=vikbooking&checkin='.$first.'&checkout='.$second.(!empty($pitemid) ? '&Itemid='.$pitemid : ''));
		}
		?>
		<li class="vbo-step vbo-step-complete"><a href="<?php echo $dateslink; ?>"><?php echo JText::_('VBSTEPDATES'); ?></a></li>
		...
		<li class="vbo-step vbo-step-complete"><a href="<?php echo JRoute::_('index.php?option=com_vikbooking&task=showprc&checkin='.$first.'&checkout='.$second.'&roomsnum='.$roomsnum.'&days='.$days.$peopleforlink.$roomoptforlink.$roomindexlink.(!empty($this->split_stay) && !empty($rq_split_stay) ? '&' . http_build_query(['split_stay' => $rq_split_stay]) : '').(!empty($pitemid) ? '&Itemid='.$pitemid : ''), false); ?>"><?php echo JText::_('VBSTEPOPTIONS'); ?></a></li>
		<?php
	}
	?>
...
<div class="vbo-oconfirm-wrapper">
	<div class="vbo-results-head vbo-results-head-oconfirm">
		<div class="vbo-results-nights">
			...
			<div class="vbo-results-head-det">
				<span class="vbo-results-head-det-lbl"><?php echo ($days == 1 ? JText::_('VBSEARCHRESNIGHT') : JText::_('VBSEARCHRESNIGHTS')); ?></span>
		...
		<div class="vbo-results-numadults">
			...
			<div class="vbo-results-head-det">
				<span class="vbo-results-head-det-lbl"><?php echo ($totadults == 1 ? JText::_('VBSEARCHRESADULT') : JText::_('VBSEARCHRESADULTS')); ?></span>
	...
	if ($showchildren && $totchildren > 0) {
		...
		<div class="vbo-results-numchildren">
			...
			<div class="vbo-results-head-det">
				<span class="vbo-results-head-det-lbl"><?php echo $totchildren == 1 ? JText::_('VBSEARCHRESCHILD') : JText::_('VBSEARCHRESCHILDREN'); ?></span>
	...
	?>
		<div class="vbo-summary-date">
			...
			<div class="vbo-results-head-det">
				<span class="vbo-results-head-det-lbl"><?php echo JText::_('VBPICKUP'); ?></span>
		...
		<div class="vbo-summary-date">
			...
			<div class="vbo-results-head-det">
				<span class="vbo-results-head-det-lbl"><?php echo JText::_('VBRETURN'); ?></span>
				<span class="vbo-results-head-det-val"><?php
		...
		<div class="vbo-oconfirm-summary-room-wrapper<?php echo $no_taxes ? ' vbo-oconfirm-summary-room-wrapper-notaxes' : ''; ?>">
			...
			<div class="vbo-oconfirm-summary-room-head">
				...
				<div class="vbo-oconfirm-summary-room-head-cell vbo-oconfirm-summary-room-cell-nights">
					<span><?php echo JText::_('ORDDD'); ?></span>
				</div>
			...
			<div class="vbo-oconfirm-summary-room-row">
				...
				<div class="vbo-oconfirm-summary-room-cell-guests">
					<span><?php echo $arrpeople[$num]['adults']; ?> <?php echo ($arrpeople[$num]['adults'] == 1 ? JText::_('VBSEARCHRESADULT') : JText::_('VBSEARCHRESADULTS')); ?><?php echo ($showchildren && $arrpeople[$num]['children'] > 0 ? ", ".$arrpeople[$num]['children']." ".($arrpeople[$num]['children'] == 1 ? JText::_('VBSEARCHRESCHILD') : JText::_('VBSEARCHRESCHILDREN')) : ""); ?></span>
				</div>
	...
	if (!empty($coupon)) {
		...
		if ($coupontotok) {
			...
			if ($coupon['maxtotord'] > 0 && $totdue > $coupon['maxtotord']) {
				VikError::raiseWarning('', JText::_('VBCOUPONINVMAXTOTORD'));
			} else {
	...
	?>
		<div class="vbo-oconfirm-summary-total-wrapper<?php echo $no_taxes ? ' vbo-oconfirm-summary-total-wrapper-notaxes' : ''; ?>">
			...
			<div class="vbo-oconfirm-summary-room-row vbo-oconfirm-summary-total-row">
				<div class="vbo-oconfirm-summary-room-cell-descr">
					<div class="vbo-oconfirm-total-block"><?php echo JText::_('VBTOTAL'); ?></div>
				</div>
				<div class="vbo-oconfirm-summary-room-cell-guests">
					<span></span>
				</div>
		...
		if ($usedcoupon == true && !empty($coupon)) {
			...
			$coupon_rm_link = JRoute::_('index.php?' . http_build_query($coupon_res_vals), true);
			?>
			<div class="vbo-oconfirm-summary-room-row vbo-oconfirm-summary-total-row vbo-oconfirm-summary-coupon-row">
				<div class="vbo-oconfirm-summary-room-cell-descr">
					<span><?php echo JText::_('VBCOUPON'); ?> <?php echo $coupon['code']; ?><a class="vbo-remove-coupon" href="<?php echo $coupon_rm_link; ?>" onclick="return confirm(Joomla.JText._('VBO_RM_COUPON_CONFIRM'));"><?php VikBookingIcons::e('times-circle'); ?></a></span>
				</div>
				<div class="vbo-oconfirm-summary-room-cell-guests">
					<span></span>
				</div>
			...
			<div class="vbo-oconfirm-summary-room-row vbo-oconfirm-summary-total-row vbo-oconfirm-summary-coupon-newtot-row">
				<div class="vbo-oconfirm-summary-room-cell-descr">
					<div class="vbo-oconfirm-total-block"><?php echo JText::_('VBNEWTOTAL'); ?></div>
				</div>
				<div class="vbo-oconfirm-summary-room-cell-guests">
					<span></span>
				</div>
		...
		if (count($this->mod_booking) && $this->mod_booking['total'] > 0) {
			...
			<div class="vbo-oconfirm-summary-room-row vbo-oconfirm-summary-total-row vbordrowtotal-prevtot">
				<div class="vbo-oconfirm-summary-room-cell-descr">
					<div class="vbo-oconfirm-total-block vbo-oconfirm-previoustotal-block"><?php echo JText::_('VBOMODBOOKPREVTOT'); ?></div>
				</div>
				<div class="vbo-oconfirm-summary-room-cell-guests">
					<span></span>
				</div>
			...
			<div class="vbo-oconfirm-summary-room-row vbo-oconfirm-summary-total-row <?php echo $modbook_diff_op == '+' ? 'vbordrowtotal-negative' : 'vbordrowtotal-positive'; ?>">
				<div class="vbo-oconfirm-summary-room-cell-descr">
					<div class="vbo-oconfirm-total-block vbo-oconfirm-diffmod-block"><?php echo JText::_('VBOMODBOOKDIFFTOT'); ?></div>
				</div>
				<div class="vbo-oconfirm-summary-room-cell-guests">
					<span></span>
				</div>
	...
	<div class="vbo-coupon-outer">
		<form action="<?php echo JRoute::_('index.php?option=com_vikbooking'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" method="post" class="vbo-coupon-form">
			<div class="vbentercoupon">
				<span class="vbhaveacoupon"><?php echo JText::_('VBHAVEACOUPON'); ?></span>
				<div class="vbentercoupon-inner">
					<input type="text" name="couponcode" value="" size="20" class="vbinputcoupon"/>
					<input type="submit" class="btn vbsubmitcoupon vbo-pref-color-btn" name="applyacoupon" value="<?php echo JText::_('VBSUBMITCOUPON'); ?>"/>
				</div>
			</div>
...
if (VikBooking::customersPinEnabled() && !VikBooking::userIsLogged() && !(count($customer_details) > 0)) {
	...
	<div class="vbo-enterpin-block">
		<div class="vbo-enterpin-top">
			<h4><?php echo JText::_('VBRETURNINGCUSTOMER'); ?></h4>
			<div class="vbo-enterpin-inner">
				<span><?php echo JText::_('VBENTERPINCODE'); ?></span>
				<div class="vbo-enterpin-btns">
					<input type="text" id="vbo-pincode-inp" value="" size="6"/>
					<button type="button" class="btn vbo-pincode-sbmt vbo-pref-color-btn"><?php echo JText::_('VBAPPLYPINCODE'); ?></button>
				</div>
			</div>
		</div>
	...
	jQuery(function() {
		jQuery(".vbo-pincode-sbmt").click(function() {
			...
			jQuery.ajax({
				type: "POST",
				url: "<?php echo VikBooking::ajaxUrl(JRoute::_('index.php?option=com_vikbooking&task=validatepin&tmpl=component'.(!empty($pitemid) ? '&Itemid='.$pitemid : ''), false)); ?>",
				data: {
					pin: pin_code
				}
			}).done(function(res) {
...
?>
  		...
  		function vboReloadStates(country_3_code) {
			...
			jQuery.ajax({
				type: "POST",
				url: "<?php echo VikBooking::ajaxUrl(JRoute::_('index.php?option=com_vikbooking&task=states_load_from_country'.(!empty($pitemid) ? '&Itemid='.$pitemid : ''), false)); ?>",
				data: {
		...
		if ($cf['type'] == "text") {
			...
			<div class="vbo-oconfirm-cfield-entry vbo-oconfirm-cfield-entry-separator">
				<div class="vbo-oconfirm-cfield-separator <?php echo $cfsepclass; ?>">
					<h4><?php echo JText::_($cf['name']); ?></h4>
				</div>
			</div>
			<?php
		} else {
			...
			<div class="vbo-oconfirm-cfield-entry vbo-oconfirm-cfield-entry-checkbox">
				...
				<div class="vbo-oconfirm-cfield-input">
					<input type="checkbox" name="vbf<?php echo $cf['id']; ?>" id="vbf-inp<?php echo $cf['id']; ?>" value="<?php echo JText::_('VBYES'); ?>" <?php echo !(bool)$cf['required'] && isset($customer_details['cfields']) && isset($customer_details['cfields'][$cf['id']]) ? 'checked="checked"' : ''; ?>/>
				</div>
			</div>
			<?php
		}
  		...
  		if (!empty($this->split_stay)) {
			...
			foreach ($this->split_stay as $spsk => $sps_room) {
				foreach ($sps_room as $sps_room_k => $sps_room_v) {
					...
					?>
		<input type="hidden" name="split_stay[<?php echo $spsk; ?>][<?php echo $sps_room_k; ?>]" value="<?php echo JHtml::_('esc_attr', $sps_room_v); ?>" />
					<?php
				}
			}
		}
...
if (!empty($payments) && !count($this->mod_booking)) {
	...
	<div class="vbo-oconfirm-paymentopts">
		<h4><?php echo JText::_('VBCHOOSEPAYMENT'); ?></h4>
	...
	if (!(count($this->mod_booking) > 0) && !VikBooking::payTotal() && VikBooking::depositAllowedDaysAdv($second) && VikBooking::depositCustomerChoice() && $dep_amount > 0 && $dep_nonrefund_allowed && ($dep_type == "fixed" || ($dep_type != "fixed" && $dep_amount < 100))) {
		...
		<div class="vbo-oconfirm-choosedeposit">
			<h4><?php echo JText::_('VBCHOOSEDEPOSIT'); ?></h4>
				...
				<div class="vbo-oconfirm-choosedeposit-block vbo-oconfirm-choosedeposit-paydeposit">
					...
					if (is_numeric($pay_balance_days_adv)) {
						...
						<div class="vbo-oconfirm-choosedeposit-paydeposit-balance">
							<span><?php echo !intval($pay_balance_days_adv) ? JText::_('VBO_PAY_BALANCE_ONARRIVAL') : JText::sprintf('VBO_PAY_BALANCE_NDAYS', (int) $pay_balance_days_adv); ?></span>
						</div>
						<?php
					}
					?>
