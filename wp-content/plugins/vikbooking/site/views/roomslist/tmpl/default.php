...
foreach ($rooms as $r) {
	$details_link = JRoute::_('index.php?option=com_vikbooking&view=roomdetails&roomid='.$r['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : ''));
		...
		<div class="room_result-inner">
			...
			?>
						...
						<div class="vbselectordiv">
							<div class="vbselectr">
								<a class="btn vbo-pref-color-btn" href="<?php echo $details_link; ?>"><?php echo JText::_('VBSEARCHRESDETAILS'); ?></a>
							</div>
						</div>			
					</div>
				</div>
