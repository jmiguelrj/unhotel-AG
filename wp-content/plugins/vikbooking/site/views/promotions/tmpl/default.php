					...
					<?php
						...
						<div class="vbo-promotion-room-block">
							...
							<div class="vbo-promotion-room-book-block">
								<a class="btn vbo-promotion-room-book-link vbo-pref-color-btn" href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=roomdetails&roomid='.$room['id'].'&checkin='.$promo['promo_from_ts'].'&promo='.$promo['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VBOPROMOROOMBOOKNOW'); ?></a>
							</div>
						</div>
							<?php
						}
