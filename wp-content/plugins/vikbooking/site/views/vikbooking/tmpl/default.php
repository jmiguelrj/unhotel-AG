...
if (VikBooking::allowBooking()) {
	...
	$selform = "<div class=\"vbdivsearch vbo-search-mainview\"><form action=\"".JRoute::_('index.php?option=com_vikbooking'.(!empty($pitemid) ? '&Itemid='.$pitemid : ''))."\" method=\"{$form_method}\"><div class=\"vb-search-inner\">\n";
	...
	<div class="vbo-booking-modification-helper">
		<div class="vbo-booking-modification-helper-inner">
			<div class="vbo-booking-modification-msg">
				<span><?php echo JText::_('VBOMODBOOKHELPSEARCH'); ?></span>
			</div>
