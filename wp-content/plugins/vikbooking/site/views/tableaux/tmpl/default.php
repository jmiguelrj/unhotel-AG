	...
	<div class="vbo-modal-overlay-content vbo-modal-overlay-content-roomdaynotes">
		...
		<div class="vbo-modal-overlay-content-body">
			...
			<div class="vbo-modal-roomdaynotes-addnew" data-readymd="" data-ymd="" data-roomid="" data-subroomid="">
				<h4><?php echo JText::_('VBOADDCUSTOMNOTETODAY'); ?></h4>
				<div class="vbo-modal-roomdaynotes-addnew-elem">
					<label for="vbo-newrdnote-name"><?php echo JText::_('VBNAME'); ?></label>
					<input type="text" id="vbo-newrdnote-name" value="" />
				</div>
				<div class="vbo-modal-roomdaynotes-addnew-elem">
					<label for="vbo-newrdnote-descr"><?php echo JText::_('VBOINVCOLDESCR'); ?></label>
				...
				<div class="vbo-modal-roomdaynotes-addnew-save">
					<button type="button" class="btn vbo-pref-color-btn" onclick="vboAddRoomDayNote(this);"><?php echo JText::_('VBOSIGNATURESAVE'); ?></button>
				</div>
			</div>
		</div>
	</div>
...
<div class="vbo-operator-tool-container">
	<div class="vbo-operator-tool-breadcrumbs">
		<span class="vbo-operator-tool-breadcrumb vbo-operator-tool-breadcrumb-home">
			<a class="vbo-pref-color-text" href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=operators' . (!empty($pitemid) ? '&Itemid=' . $pitemid : '')); ?>">
				<?php VikBookingIcons::e('th-list'); ?>
				<span class="vbo-operator-tool-breadcrumb-name"><?php echo JText::_('VBMENUDASHBOARD'); ?></span>
...
<div class="vbo-tableaux-todaystats">
	<div class="vbo-tableaux-todaystat">
		<div class="vbo-tableaux-todaystat-inner">
			<span class="vbo-tableaux-today-lbl"><?php echo JText::_('VBOTABLEAUXARRTD'); ?></span>
			<span class="vbo-tableaux-today-val"><?php echo $tod_arrive; ?></span>
		</div>
		<div class="vbo-tableaux-todaystat-inner">
			<span class="vbo-tableaux-today-lbl"><?php echo JText::_('VBOTABLEAUXARRTM'); ?></span>
			<span class="vbo-tableaux-today-val"><?php echo $tom_arrive; ?></span>
		</div>
	</div>
	<div class="vbo-tableaux-todaystat">
		<div class="vbo-tableaux-todaystat-inner">
			<span class="vbo-tableaux-today-lbl"><?php echo JText::_('VBOTABLEAUXDEPTD'); ?></span>
			<span class="vbo-tableaux-today-val"><?php echo $tod_depart; ?></span>
		</div>
		<div class="vbo-tableaux-todaystat-inner">
			<span class="vbo-tableaux-today-lbl"><?php echo JText::_('VBOTABLEAUXDEPTM'); ?></span>
			<span class="vbo-tableaux-today-val"><?php echo $tom_depart; ?></span>
		</div>
	</div>
	<div class="vbo-tableaux-todaystat">
		<div class="vbo-tableaux-todaystat-inner">
			<span class="vbo-tableaux-today-lbl"><?php echo JText::_('VBOTABLEAUXSTYTD'); ?></span>
			<span class="vbo-tableaux-today-val"><?php echo $tod_stays; ?></span>
		</div>
		<div class="vbo-tableaux-todaystat-inner">
			<span class="vbo-tableaux-today-lbl"><?php echo JText::_('VBOTABLEAUXSTYTM'); ?></span>
					...
					<tbody>
						<tr class="vbo-tableaux-monthsrow">
							<td class="vbo-tableaux-emptycell">
								<a href="javascript: void(0);" class="vbo-tableaux-togglefullscreen" title="<?php echo htmlentities(JText::_('VBOTGLFULLSCREEN')); ?>"><?php VikBookingIcons::e('expand'); ?></a>
							</td>
						<?php
									...
									if (!empty($operator_perms['roomextras'])) {
										...
										if (!empty($room_options[$nowdataindex])) {
											...
											if (count($room_options_list)) {
												$room_extra_infos[] = JText::_('VBACCOPZ') . ': ' . implode(', ', $room_options_list);
											}
										}
										...
										if (!empty($room_extras[$nowdataindex])) {
											...
											if (count($room_extras_list)) {
												$room_extra_infos[] = JText::_('VBOEXTRASERVICES') . ': ' . implode(', ', $room_extras_list);
											}
										}
...
function vboAddRoomDayNote(that) {
	...
	var jqxhr = jQuery.ajax({
		type: "POST",
		url: "<?php echo VikBooking::ajaxUrl(JRoute::_('index.php?option=com_vikbooking&task=add_roomdaynote&tmpl=component'.(!empty($pitemid) ? '&Itemid='.$pitemid : ''), false)); ?>",
		data: {
