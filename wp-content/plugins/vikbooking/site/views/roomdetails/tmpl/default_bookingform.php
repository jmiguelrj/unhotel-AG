...
<div class="vbo-seldates-cont">
	...
	if ($paramshowpeople > 0) {
		...
		if ($paramshowpeople == 1) {
			?>
			<div class="vbmaxadultsdet"><span class="vbmaximgdet vbo-rdetails-capacity-icn"><?php VikBookingIcons::e('male'); ?></span><span class="vbmaxlabeldet"><?php echo JText::_('VBFORMADULTS'); ?></span><span class="vbmaxnumberdet"><?php echo $maxadustr; ?></span></div>
			<?php
		} elseif ($paramshowpeople == 2) {
			?>
			<div class="vbmaxchildrendet"><span class="vbmaximgdet vbo-rdetails-capacity-icn"><?php VikBookingIcons::e('child'); ?></span><span class="vbmaxlabeldet"><?php echo JText::_('VBFORMCHILDREN'); ?></span><span class="vbmaxnumberdet"><?php echo $maxchistr; ?></span></div>
			<?php
		} elseif ($paramshowpeople == 3) {
			?>
			<div class="vbmaxadultsdet"><span class="vbmaximgdet vbo-rdetails-capacity-icn"><?php VikBookingIcons::e('male'); ?></span><span class="vbmaxlabeldet"><?php echo JText::_('VBFORMADULTS'); ?></span><span class="vbmaxnumberdet"><?php echo $maxadustr; ?></span></div>
			<div class="vbmaxtotdet"><span class="vbmaximgdet vbo-rdetails-capacity-icn"><?php VikBookingIcons::e('users'); ?></span><span class="vbmaxlabeldet"><?php echo JText::_('VBMAXTOTPEOPLE'); ?></span><span class="vbmaxnumberdet"><?php echo $maxtotstr; ?></span></div>
			<?php
	...
	if (VikBooking::allowBooking()) {
		...
		$selform = "<div class=\"vbdivsearch" . (!strcasecmp($layout, 'listing') ? ' vbo-listing-details-divsearch' : '') . "\"><form action=\"".JRoute::_('index.php?option=com_vikbooking'.(!empty($pitemid) ? '&Itemid='.$pitemid : ''))."\" method=\"{$form_method}\" onsubmit=\"return vboValidateDates();\"><div class=\"vb-search-inner\">\n";
		...
		$selform .= "		<div class=\"vbo-search-num-aduchild-entry\">" . ($multi_units === 1 && $this->room['units'] > 1 ? "<span class=\"vbo-search-roomnum\">".JText::_('VBFORMNUMROOM')." 1</span>" : '') . "\n";
		...
		<div class="vbo-js-helpers" style="display: none;">
			<div class="vbo-add-element-html">
				<div class="vbo-search-num-aduchild-entry">
					<span class="vbo-search-roomnum"><?php echo JText::_('VBFORMNUMROOM'); ?> %d</span>
					<div class="vbo-search-num-adults-entry">
						<label class="vbo-search-num-adults-entry-label"><?php echo JText::_($use_guests_label); ?></label>
				...
				if ($showchildren) {
					...
					<div class="vbo-search-num-children-entry">
						<label class="vbo-search-num-children-entry-label"><?php echo JText::_('VBFORMCHILDREN'); ?></label>
