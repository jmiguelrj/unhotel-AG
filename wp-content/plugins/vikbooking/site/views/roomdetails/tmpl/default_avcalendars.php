...
<div class="vbo-availcalendars-cont">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_vikbooking&view=roomdetails&roomid='.$this->room['id'].'&Itemid='.$pitemid); ?>" method="post" name="vbmonths">
	...
	<div class="vblegendediv">
		...
		<span class="vblegenda"><span class="vblegenda-status vblegfree">&nbsp;</span> <span class="vblegenda-lbl"><?php echo JText::_('VBLEGFREE'); ?></span></span>
	<?php
	if ($showpartlyres) {
		?>
		<span class="vblegenda"><span class="vblegenda-status vblegwarning">&nbsp;</span> <span class="vblegenda-lbl"><?php echo JText::_('VBLEGWARNING'); ?></span></span>
		<?php
	}
	if ($showcheckinoutonly) {
		?>
		<span class="vblegenda"><span class="vblegenda-status vblegbusycheckout">&nbsp;</span> <span class="vblegenda-lbl"><?php echo JText::_('VBLEGBUSYCHECKOUT'); ?></span></span>
		<span class="vblegenda"><span class="vblegenda-status vblegbusycheckin">&nbsp;</span> <span class="vblegenda-lbl"><?php echo JText::_('VBLEGBUSYCHECKIN'); ?></span></span>
		<?php
	}
	?>
		<span class="vblegenda"><span class="vblegenda-status vblegbusy">&nbsp;</span> <span class="vblegenda-lbl"><?php echo JText::_('VBLEGBUSY'); ?></span></span>
...
?>
	jQuery(document.body).on('click', '.vbo-rdet-avcal-nav', function() {
		...
		var jqxhr = jQuery.ajax({
			type: "POST",
			url: "<?php echo VikBooking::ajaxUrl(JRoute::_('index.php?option=com_vikbooking&task=get_avcalendars_data&tmpl=component'.(!empty($pitemid) ? '&Itemid='.$pitemid : ''), false)); ?>",
			data: {
