...
<div style="display: inline-block; width: 100%;">
	...
	<br/>
	<h4 style="text-align: center;"><?php echo JText::_('VBOCHECKINDOCTITLE'); ?></h4>
	<p> </p>
	<?php
	...
	<table width="100%" align="center" border="0" cellspacing="1" cellpadding="2" border="1" style="border: 1px solid #363636;">
		<tr>
			<td align="center" valign="top"><strong><?php echo JText::_('VBCUSTOMERFIRSTNAME'); ?></strong></td>
			<td align="center" valign="top"><strong><?php echo JText::_('VBCUSTOMERLASTNAME'); ?></strong></td>
			<td align="center" valign="top"><strong><?php echo JText::_('VBOCHECKINDOCARRVDT'); ?></strong></td>
			<td align="center" valign="top"><strong><?php echo JText::_('VBOCHECKINDOCDEPADT'); ?></strong></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2" style="border: 1px solid #000000;">
		<tr>
			...
			<td align="center" valign="top" style="border-right: 1px solid #000000;"><strong><?php echo JText::_('VBEDITORDERADULTS'); ?></strong></td>
			<td align="center" valign="top"><strong><?php echo JText::_('VBEDITORDERCHILDREN'); ?></strong></td>
		</tr>
		<tr>
		...
		if ($customer && is_array(($customer['pax_data'][$k] ?? null)) && $customer['pax_data'][$k]) {
			?>
		<tr>
			<td align="left" valign="top" style="border-right: 1px solid #000000;"><strong><?php echo JText::_('VBOGUESTSDETAILS'); ?></strong></td>
			<td align="center" valign="top" style="border-right: 1px solid #000000;"><strong><?php echo JText::_('VBCUSTOMERFIRSTNAME'); ?></strong></td>
			<td align="center" valign="top"><strong><?php echo JText::_('VBCUSTOMERLASTNAME'); ?></strong></td>
		</tr>
		<tr>
	...
	<div style="display: inline-block; width: 100%;">
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				<td align="left" valign="top"><strong><?php echo JText::_('VBOCHECKINDOCTODAYDT'); ?></strong></td>
				<td align="center" valign="top"><strong><?php echo JText::_('VBOCHECKINDOCGUESTSIGN'); ?></strong></td>
			</tr>
			<tr>
