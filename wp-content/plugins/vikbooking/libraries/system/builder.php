...
class VikBookingBuilder
{
	...
	public static function setupAdminMenu()
	{
		...
		add_menu_page(
			JText::_('COM_VIKBOOKING'), 	// page title
			JText::_('COM_VIKBOOKING_MENU'), 	// menu title
	...
	public static function setupHtmlHelpers()
	{
		...
		JHtml::register('system.js', function()
		{
			...
			if (!$loaded)
			{
				...
				JHtml::_('script', VBO_ADMIN_URI . 'resources/js/system.js', $internalFilesOptions, array('id' => 'vbo-sys-script'));
				JHtml::_('stylesheet', VBO_ADMIN_URI . 'resources/css/system.css', $internalFilesOptions, array('id' => 'vbo-sys-style'));
				...
				if (JFactory::getApplication()->isAdmin() || (class_exists('VikBooking') && VikBooking::loadBootstrap()))
				{
					 ...
					 * @since 	1.3.5
					 */
					JHtml::_('script', VBO_ADMIN_URI . 'resources/js/bootstrap.min.js', $internalFilesOptions, array('id' => 'bootstrap-script'));

					JHtml::_('stylesheet', VBO_ADMIN_URI . 'resources/css/bootstrap.lite.css', $internalFilesOptions, array('id' => 'bootstrap-lite-style'));
				}
			}
		});
		...
		JHtml::register('select2', function()
		{
			 ...
			 * @since 1.2.5
			 */
			JHtml::_('script', VBO_ADMIN_URI . 'resources/select2.min.js');
			JHtml::_('stylesheet', VBO_ADMIN_URI . 'resources/select2.min.css');
		});
