                ...
                <div class="vbo-params-container">
                    <div class="vbo-params-block">
                        ...
                        <div class="vbo-param-container">
                            <div class="vbo-param-label"><?php echo JText::_('VBOBOOKINGLANG'); ?></div>
                            <div class="vbo-param-setting">
                                <select class="<?php echo $prefix; ?>-field" data-field="language">
                                    <option value="">- <?php echo JText::_('VBCONFIGSEARCHPSMARTSEARCHAUTO'); ?> -</option>
                                <?php
                        ...
                        if (($room ?? []) && !$info) {
                            ...
                            $room_ai_infos = [
                                $room['name'] ?? '',
                                JText::_('VBEDITORDERADULTS') . ': ' . ($room['toadult'] ?? 1),
                                (($room['tochild'] ?? 0) > 0 ? (JText::_('VBEDITORDERCHILDREN') . ': ' . $room['tochild']) : ''),
                                ($address ? (JText::_('VBO_GEO_ADDRESS') . ': ' . $address) : ''),
                                (!$address && $latitude ? (JText::_('VBPLACELAT') . ': ' . $latitude) : ''),
                                (!$address && $longitude ? (JText::_('VBPLACELNG') . ': ' . $longitude) : ''),
                            ];
                        ...
                        ?>
                        <div class="vbo-param-container">
                            <div class="vbo-param-label"><?php echo JText::_('VBOADMINLEGENDDETAILS'); ?></div>
                            <div class="vbo-param-setting">
                                <textarea rows="6" class="<?php echo $prefix; ?>-field" data-field="information"><?php echo JHtml::_('esc_textarea', $room_def_ai_info); ?></textarea>
                                <span class="vbo-param-setting-comment"><?php echo $help ?: JText::_('VBO_AI_GEN_CONTENT_INFO_HELP'); ?></span>
                            </div>
                        </div>
