...
<div class="vbo-help-wizard-instruction-description">
    ...
    <?php if (!$configured): ?>
        ...
        <p>Puoi configurare un driver per automatizzare l'invio dei dati statistici giornalieri richiesti da ISTAT tramite il portale ROSS1000.</p>

        <p>Mantieni la tua struttura in regola con gli obblighi di comunicazione, senza compilazioni manuali o perdite di tempo.</p>
    ...
    <?php elseif ($autoexport): ?>
        ...
        <p>Facendo clic sul pulsante sottostante, il sistema completerà la configurazione per te, in base alle impostazioni più appropriate per ROSS1000. In pratica, ogni giorno il sistema invierà in modo automatico i dati sulle presenze turistiche del giorno precedente.</p>
