...
<div class="vbo-help-wizard-instruction-description">
    ...
    <?php if (!$configured): ?>
        ...
        <p>Con il driver dedicato puoi automatizzare l'invio dei dati statistici al portale OTRS (Osservatorio Turistico Regione Sicilia), secondo gli obblighi regionali della Sicilia.</p>
    ...
    <?php elseif ($autoexport): ?>
        ...
        <p>Facendo clic sul pulsante sottostante, il sistema completerà la configurazione per te, in base alle impostazioni più appropriate per OTRS. In pratica il sistema invierà in modo automatico i dati relativi a check-in, check-out e chiusure con cadenza giornaliera.</p>
