	...
	<div class="vbo-sidepanel-container">
		...
		<div class="vbo-sidepanel-layouts">
			...
			<div class="vbo-sidepanel-colorscheme">
				<span class="vbo-tooltip vbo-tooltip-bottom vbo-sidepanel-colorscheme-current" data-tooltiptext="<?php echo JHtml::_('esc_attr', $scheme_name); ?>"><?php VikBookingIcons::e($current_mode); ?></span>
		...
		<div class="vbo-sidepanel-body-top">
			...
			<div class="vbo-sidepanel-search">
				...
				<input id="vbo-sidepanel-search-input" type="text" placeholder="<?php echo htmlspecialchars(JText::_('VBO_SEARCH_ADMIN_WIDGETS')); ?>" value="" autocomplete="off" />
			</div>
			...
			?>
				<div class="vbo-sidepanel-add-widgets-nores" style="display: none;">
					<span><?php echo JText::_('VBONORESULTS'); ?></span>
				</div>
			</div>
		...
		<div class="vbo-sidepanel-edit-widgets">
			<div class="vbo-sidepanel-edit-widgets-wrap">
				<button class="btn btn-small vbo-sidepanel-edit-widgets-trig" style="<?php echo !count($active_widgets) ? 'display: none;' : ''; ?>"><?php echo JText::_('VBO_WIDGETS_CUSTWIDGETS'); ?></button>
			</div>
		</div>
