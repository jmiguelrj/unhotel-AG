    ...
    <div class="vbo-admin-container vbo-admin-container-full vbo-admin-container-compact">
        <div class="vbo-params-wrap">
            ...
            if ($instance->allowsProfileSettings()) {
                ...
                $profile_name = $active_profile ? ($report_profiles[$active_profile] ?? JText::_('VBO_USE_DEFAULT')) : JText::_('VBO_USE_DEFAULT');
                    ...
                    <div class="vbo-param-container">
                        ...
                        <div class="vbo-param-setting">
                            <select name="_profile" onchange="VBOCore.emitEvent('vbo-report-settings-profile-changed', {value: this.value});">
                                <option value="<?php echo JHtml::_('esc_attr', $active_profile); ?>"><?php echo $profile_name; ?></option>
                                <option value="_new"><?php echo JText::_('VBO_PROFILE_NEW'); ?></option>
                            </select>
                            <span class="vbo-param-setting-comment"><?php echo JText::_('VBO_PROFILE_SETTINGS_HELP'); ?></span>
                        </div>
                    </div>
