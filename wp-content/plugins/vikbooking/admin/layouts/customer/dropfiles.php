...
<fieldset class="adminform">
	<div class="vbo-params-wrap">
		<legend class="adminlegend"><?php echo JText::_('VBOCUSTOMERDOCUMENTS'); ?></legend>
...
?>
			<div class="vbo-dropfiles-target">
				...
				<div class="lead">
					<a href="javascript: void(0);" id="upload-file"><?php echo JText::_('VBOMANUALUPLOAD'); ?></a>&nbsp;<?php echo JText::_('VBODROPFILES'); ?>
				</div>

				<p class="maxsize">
					<?php echo JText::sprintf('JGLOBAL_MAXIMUM_UPLOAD_SIZE_LIMIT', JHtml::_('vikbooking.maxuploadsize')); ?>
				</p>
			...
			<div class="drop-files-hint">
				...
				echo VikBooking::getVboApplication()->createPopover(array(
					'title'     => 'Drop Files',
					'content'   => JText::_('VBODROPFILESHINT'),
					'placement' => 'left',
				));
				?>
			</div>
...
<div class="stop-managing-files-hint"><?php echo JText::_('VBODROPFILESSTOPREMOVING'); ?></div>
