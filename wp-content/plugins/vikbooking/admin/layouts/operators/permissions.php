    ...
    <div class="vbo-operator-tool-permissions-wrap">
        <div class="vbo-operator-tools-list">
            <div class="vbo-operator-tool-tab vbo-operator-tool-tab-activeperms vbo-operator-tool-tab-active" data-tool-id="">
                <span class="vbo-operator-tool-name"><?php echo JText::_('VBO_ACTIVE_PERMS'); ?></span>
            </div>
        <?php
        foreach ($permission_types as $tool_id => $tool_data) {
            ?>
            <div class="vbo-operator-tool-tab" data-tool-id="<?php echo JHtml::_('esc_attr', $tool_id); ?>">
            ...
            <div class="vbo-operator-tool-permissions vbo-operator-tool-permissions-activeperms" data-tool-id="">
                <div class="vbo-admin-container vbo-admin-container-full vbo-admin-container-compact">
                    ...
                    if ($operator_id) {
                            ...
                            <div class="vbo-params-block">
                                <div class="vbo-param-container">
                                    ...
                                    <div class="vbo-param-setting">
                                        <button type="button" class="btn vbo-tool-permissions-edit-btn" data-operator-id="<?php echo $operator['id']; ?>" data-tool-id="<?php echo $tool_perms['type']; ?>"><?php VikBookingIcons::e('edit'); ?> <?php echo JText::_('VBMAINPAYMENTSEDIT'); ?></button>
                                        <button type="button" class="btn btn-danger vbo-permissions-del-btn" data-operator-id="<?php echo $operator['id']; ?>" data-tool-id="<?php echo $tool_perms['type']; ?>"><?php VikBookingIcons::e('times'); ?> <?php echo JText::_('VBELIMINA'); ?></button>
                                    </div>
                                </div>
                            </div>
                            <?php
                        ...
                        if (!$operator['perms']) {
                            ?>
                            <p class="info"><?php echo JText::_('VBO_NO_RECORDS_FOUND'); ?></p>
                            <?php
                        }
                    } elseif ($tool) {
                        ...
                        foreach ($active_operators as $active_operator) {
                            ...
                            <div class="vbo-params-block">
                                <div class="vbo-param-container">
                                    ...
                                    <div class="vbo-param-setting">
                                        <input type="hidden" class="vbo-operator-tool-permissions-json" value="<?php echo JHtml::_('esc_attr', $operator_tool_perms); ?>" />
                                        <button type="button" class="btn vbo-oper-permissions-edit-btn" data-operator-id="<?php echo $active_operator['id']; ?>" data-tool-id="<?php echo $tool; ?>"><?php VikBookingIcons::e('edit'); ?> <?php echo JText::_('VBMAINPAYMENTSEDIT'); ?></button>
                                        <button type="button" class="btn btn-danger vbo-permissions-del-btn" data-operator-id="<?php echo $active_operator['id']; ?>" data-tool-id="<?php echo $tool; ?>"><?php VikBookingIcons::e('times'); ?> <?php echo JText::_('VBELIMINA'); ?></button>
                                    </div>
                                </div>
                            </div>
                            <?php
                        ...
                        if (!$active_operators) {
                            ?>
                            <p class="<?php echo !$operators_list ? 'error' : 'info' ?>"><?php echo JText::_('VBNOOPERATORS'); ?></p>
                            <?php
                        }
                    }
                    ?>
        ...
        foreach ($permission_types as $tool_id => $tool_data) {
            ...
            if ($tool) {
                ...
                $tool_permissions = array_merge([
                    '_operator_id' => [
                        'type'          => 'select',
                        'label'         => JText::_('VBOOPERATOR'),
                        'help'          => JText::_('VBOADDOPERATORPERM'),
                        'assets'        => true,
                        'asset_options' => [
                            'placeholder' => '',
                            'allowClear'  => true,
            ...
            ?>
            <div class="vbo-operator-tool-permissions vbo-operator-tool-tab-selector" data-tool-id="<?php echo JHtml::_('esc_attr', $tool_id); ?>" style="display: none;">
                <div class="vbo-admin-container vbo-admin-container-full vbo-admin-container-compact">
                    <div class="vbo-params-wrap">
                        <div class="vbo-params-container">
                ...
                if ($operator_id && !in_array($tool_id, array_column($operator['perms'], 'type'))): ?>
                    <p class="warn"><?php echo JText::_('VBO_OPERATOR_NO_TOOL_PERMS'); ?></p>
                <?php endif; ?>
            </div>
            <?php
        }
