...
final class VBONotificationCenter
{
	...
	private function generatePastMonthNotification(array $month)
	{
		...
		$notification = [
			...
			'summary'        => JText::_('VBO_CHECK_HOW_WENT'),
			'label'          => JText::_('VBO_W_FINANCE_TITLE'),
			'widget'         => 'finance',
			'widget_options' => [
	...
	private function generatePendingAiDraftsNotification(int $count)
	{
		...
		$notification = [
			...
			'title'          => JText::_('VBO_W_AITRAININGDRAFTS_TITLE'),
