...
/**
 * Task status implementation for type "in progress".
 * 
 * @since   1.18.0 (J) - 1.8.0 (WP)
 */
class VBOTaskStatusTypeInprogress extends VBOTaskStatusAware
{
    ...
    {
        return $this->displayOngoingWork($task, $paused = false);
    }
}
