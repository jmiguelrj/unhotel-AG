...
final class VBOCheckinPaxfieldTypeSignature extends VBOCheckinPaxfieldType
{
	...
	public function render()
	{
		...
		$viewdoc_lbl = JText::_('VBO_PRECHECKIN_VIEW_DOCUMENT');
		$viewdoc_icon = '<i class="' . VikBookingIcons::i('file-contract') . '"></i>';

		// sign document label and icon
		$signdoc_lbl = JText::_('VBO_PRECHECKIN_SIGN_DOCUMENT');
		$signabove_lbl = JText::_('VBOSIGNATURESIGNABOVE');
		$signsave_lbl = JText::_('VBOSIGNATURESAVE');
		$signclear_lbl = JText::_('VBOSIGNATURECLEAR');
