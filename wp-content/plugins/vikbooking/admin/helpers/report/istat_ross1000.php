...
class VikBookingReportIstatRoss1000 extends VikBookingReport
{
	...
	public function __construct()
	{
		...
		$this->reportName = JText::_('ISTAT Ross 1000');
		$this->reportFilters = [];
	...
	public function getFilters()
	{
		...
		$filter_opt = array(
			'label' => '<label class="vbo-report-ross1000-manualsave" style="display: none;">' . JText::_('VBOGUESTSDETAILS') . '</label>',
			'html' => '<button type="button" class="btn vbo-config-btn vbo-report-ross1000-manualsave" style="display: none;" onclick="vboRoss1000SaveData();"><i class="' . VikBookingIcons::i('save') . '"></i> ' . JText::_('VBSAVE') . '</button>',
		);
		array_push($this->reportFilters, $filter_opt);
