	...
	public function getReportData()
	{
		...
		$this->cols = array(
			...
			array(
				'key' => 'customer',
				'sortable' => 1,
				'label' => JText::_('VBOREPORTOURISTTAXCUSTOMER')
			),
			//country
			array(
				'key' => 'country',
				'sortable' => 1,
				'label' => JText::_('VBOREPORTTOPCOUNTRIESC')
			),
			//adults
			array(
				'key' => 'adults',
			...
			array(
				...
				'sortable' => 1,
				'label' => JText::_('VBOREPORTOURISTTAXTOT')
			)
		);
