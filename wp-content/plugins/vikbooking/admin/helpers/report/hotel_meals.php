...
class VikBookingReportHotelMeals extends VikBookingReport
{
	...
	public function __construct()
	{
		...
		$this->reportName = 'Hotel - ' . JText::_('VBO_MEALS');
	...
	public function getReportData()
	{
		...
		$this->cols = array(
			...
			array(
				...
				'sortable' => 1,
				'label' => JText::_('VBO_MEAL_BREAKFAST')
			),
			// lunch
			array(
				'key' => 'lunch',
			...
			array(
				...
				'sortable' => 1,
				'label' => JText::_('VBOCHANNELS'),
				'tip' => JText::_('VBO_CRON_OTA_RES'),
			),
		);
