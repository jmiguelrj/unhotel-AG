...
class VikBookingReportEsMossosDesquadra extends VikBookingReport
{
	...
	public function getFilters()
	{
		...
		$filter_opt = array(
			...
			'html' => '<button type="button" class="btn vbo-config-btn vbo-report-mossosdesquadra-manualsave" style="display: none;" onclick="vboMossosDesquadraSaveData();"><i class="' . VikBookingIcons::i('save') . '"></i> ' . JText::_('VBSAVE') . '</button>',
		);
		array_push($this->reportFilters, $filter_opt);
