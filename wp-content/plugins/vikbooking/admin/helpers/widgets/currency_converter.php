...
class VikBookingAdminWidgetCurrencyConverter extends VikBookingAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VBO_W_CURRCONV_TITLE');
		$this->widgetDescr = JText::_('VBO_W_CURRCONV_DESCR');
	...
	public function exchangeRates()
	{
		...
		if ($converter_error || empty($exchanged)) {
			...
			<p class="info"><?php echo JText::_('VBO_CONV_RATE'); ?> <span class="badge badge-primary"><?php echo $exchange_rate; ?></span></p>
			<?php
		}
		?>
		</div>
				...
				<div class="vbo-widget-currconv-filters">
					<div class="vbo-widget-currconv-filters-main">
						<div class="vbo-widget-currconv-filter vbo-widget-currconv-filter-from">
							<label for="vbo-widget-currconv-from-<?php echo $wrapper_instance; ?>"><?php echo JText::_('VBO_CONV_FROM'); ?></label>
						...
						<div class="vbo-widget-currconv-filter vbo-widget-currconv-filter-amount">
							<label for="vbo-widget-currconv-amount-<?php echo $wrapper_instance; ?>"><?php echo JText::_('VBPSHOWSEASONSFOUR'); ?></label>
					...
					<div class="vbo-widget-currconv-filters-secondary">
						<div class="vbo-widget-currconv-filter vbo-widget-currconv-filter-to">
							<label for="vbo-widget-currconv-to-<?php echo $wrapper_instance; ?>"><?php echo JText::_('VBO_CONV_TO'); ?></label>
					...
					<div class="vbo-widget-currconv-filters-submit">
						<div class="vbo-widget-currconv-filter vbo-widget-currconv-filter-submit">
							<button type="button" class="btn vbo-config-btn" onclick="vboWidgetCurrConvCalc('<?php echo $wrapper_id; ?>');"><?php VikBookingIcons::e('exchange-alt'); ?><?php echo JText::_('VBRATESOVWRATESCALCULATORCALC'); ?></button>
						</div>
					</div>
				</div>
