...
class VikBookingAdminWidgetWeeklyBookings extends VikBookingAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VBO_W_WEEKLYB_TITLE');
		$this->widgetDescr = JText::_('VBO_W_WEEKLYB_DESCR');
	...
	<div class="vbo-admin-widget-wrapper">
		<div class="vbo-admin-widget-head">
			<div class="vbo-admin-widget-head-inline">
				<h4><?php echo $this->widgetIcon; ?> <span><?php echo JText::_('VBDASHWEEKGLOBAVAIL'); ?></span></h4>
