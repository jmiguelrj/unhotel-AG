...
class VikBookingAdminWidgetNextBookings extends VikBookingAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VBO_W_NEXTRES_TITLE');
		$this->widgetDescr = JText::_('VBO_W_NEXTRES_DESCR');
	...
	public function render(?VBOMultitaskData $data = null)
	{
		...
		<div class="vbo-admin-widget-wrapper">
			<div class="vbo-admin-widget-head">
				<h4><?php echo $this->widgetIcon; ?> <span><?php echo JText::_('VBDASHUPCRES'); ?></span></h4>
			</div>
