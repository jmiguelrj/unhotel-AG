...
class VikBookingAdminWidgetAitools extends VikBookingAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VBO_W_AITOOLS_TITLE');
		$this->widgetDescr = JText::_('VBO_W_AITOOLS_DESCR');
	...
	public function preload()
	{
		...
		if (class_exists('VikChannelManager')) {
			...
			JHtml::_('script', VCM_ADMIN_URI . 'layouts/ai/assistant/aitools.js', $options);
			JHtml::_('stylesheet', VCM_ADMIN_URI . 'layouts/ai/assistant/aitools.css', $options);

			JHtml::_('script', VCM_ADMIN_URI . 'assets/js/katex/katex.min.js', $options);
			JHtml::_('script', VCM_ADMIN_URI . 'assets/js/katex/auto-render.min.js', $options);
			JHtml::_('stylesheet', VCM_ADMIN_URI . 'assets/js/katex/katex.min.css', $options);
