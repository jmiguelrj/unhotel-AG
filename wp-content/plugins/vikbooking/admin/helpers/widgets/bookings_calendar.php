...
class VikBookingAdminWidgetBookingsCalendar extends VikBookingAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VBO_W_BOOKSCAL_TITLE');
		$this->widgetDescr = JText::_('VBO_W_BOOKSCAL_DESCR');
	...
	public function loadBookingsCalendar()
	{
		...
		if (!empty($room_id) && isset($all_rooms[$room_id])) {
			...
			$search_name = preg_replace("/[^A-Za-z0-9 ]/", '', JText::_('VBOSTATSALLROOMS'));
		}
		...
		<div class="vbo-widget-booskcal-mday-wrap" style="display: none;">
			...
			<div class="vbo-widget-booskcal-mday-pricing" style="display: none;">
				<div class="vbo-widget-booskcal-mday-pricing-title">
					<span><?php echo JText::_('VBO_RATES_AND_RESTR'); ?></span>
				</div>
				<div class="vbo-widget-booskcal-mday-hidden-helper" style="display: none;">
					<div class="vbo-widget-booskcal-mday-hidden-helper-togglebtn vbo-toggle-small">
						<?php echo $this->vbo_app->printYesNoButtons('updotas', JText::_('VBYES'), JText::_('VBNO'), 1, 1, 0, '', ['blue']); ?>
					</div>
				</div>
				<div class="vbo-widget-booskcal-mday-pricing-data">
					...
					<div class="vbo-widget-booskcal-mday-pricing-data-restr">
						<div class="vbo-widget-booskcal-mday-pricing-data-minlos">
							<span><?php echo JText::_('VBOMINIMUMSTAY'); ?></span>
		...
		<div class="vbo-widget-booskcal-newbook-wrap" data-ymd="" data-roomid="" style="display: none;">
			<div class="vbo-widget-booskcal-newbook-head">
				<a class="vbo-widget-booskcal-newbook-back" href="JavaScript: void(0);" onclick="vboWidgetBooksCalMonth('<?php echo $wrapper; ?>');"><?php VikBookingIcons::e('chevron-left'); ?> <?php echo JText::_('VBANNULLA'); ?></a>
				<span class="vbo-widget-booskcal-newbook-name"><?php echo JText::_('VBQUICKBOOK'); ?></span>
			</div>
						...
						<div class="vbo-params-container">
							<div class="vbo-params-block">
								...
								<div class="vbo-param-container vbo-toggle-small">
									<div class="vbo-param-label"><?php echo JText::_('VBSUBMCLOSEROOM'); ?></div>
									<div class="vbo-param-setting">
										<?php echo $this->vbo_app->printYesNoButtons('closeroom', JText::_('VBYES'), JText::_('VBNO'), 0, 1, 0, "vboWidgetBooksCalClosure('{$wrapper}');"); ?>
									</div>
								</div>

								<div class="vbo-param-container" data-noclosure="1">
									<div class="vbo-param-label"><?php echo JText::_('VBOCUSTOMER'); ?></div>
									<div class="vbo-param-setting">
								...
								<div class="vbo-param-container" data-noclosure="1">
									<div class="vbo-param-label"><?php echo JText::_('VBPVIEWORDERSPEOPLE'); ?></div>
									<div class="vbo-param-setting">
										<span class="vbo-quickres-aduchi-wrap">
											<span class="vbo-quickres-aduchi-inlbl"><?php echo JText::_('VBEDITORDERADULTS'); ?></span>
										...
										<span class="vbo-quickres-aduchi-wrap">
											<span class="vbo-quickres-aduchi-inlbl"><?php echo JText::_('VBEDITORDERCHILDREN'); ?></span>
								...
								<div class="vbo-param-container vbo-param-confirm-btn">
									...
									<div class="vbo-param-setting">
										<button type="button" class="btn btn-success vbo-btn-wide" onclick="vboWidgetBooksCalSaveBooking('<?php echo $wrapper; ?>');"><?php VikBookingIcons::e('save'); ?> <?php echo JText::_('VBSAVE'); ?></button>
									</div>
								</div>
		...
		<div class="vbo-widget-booskcal-calendar-table-wrap">
			...
			<div class="vbo-widget-bookscal-mngrates-toggle vbo-toggle-small">
				<label for="vbo-wbookscal-mng-rates-restr-on"><?php echo JText::_('VBO_RATES_AND_RESTR'); ?></label>
				<?php echo $this->vbo_app->printYesNoButtons('vbo-wbookscal-mng-rates-restr', JText::_('VBYES'), JText::_('VBNO'), $mng_rates_restr, 1, 0, "vboWidgetBooksCalManageRatesRestr('{$wrapper}');", ['orange']); ?>
			</div>
				<?php
			}
			?>
	...
	public function loadMdayBookings()
	{
		...
		if (!$booking_details && !$cancellations) {
			?>
			<p class="info"><?php echo JText::_('VBNOORDERSFOUND'); ?></p>
			<?php
		} else {
			if (!$booking_details) {
				?>
			...
			foreach ($booking_details as $booking) {
				...
				$nights_lbl = $booking['days'] > 1 ? JText::_('VBDAYS') : JText::_('VBDAY');
				$rooms_lbl = !empty($booking['roomsnum']) && $booking['roomsnum'] > 1 ? ', ' . $booking['roomsnum'] . ' ' . JText::_('VBPVIEWORDERSTHREE') : '';
				// compose customer name
				$customer_name = !empty($booking['customer_fullname']) ? $booking['customer_fullname'] : '';
				if ($booking['closure'] > 0 || !strcasecmp((string) $booking['custdata'], JText::_('VBDBTEXTROOMCLOSED'))) {
					$customer_name = '<span class="vbordersroomclosed"><i class="' . VikBookingIcons::i('ban') . '"></i> ' . JText::_('VBDBTEXTROOMCLOSED') . '</span>';
				}
				...
				<div class="vbo-bookings-status-separator">
					<button type="button" class="btn btn-small btn-secondary" onclick="vboWidgetBooksCalCancToggle('<?php echo $wrapper; ?>');"><?php echo JText::_('VBO_SHOW_CANCELLATIONS'); ?></button>
				</div>
					<?php
				}
						...
						<div class="vbo-dashboard-guest-activity-content-head">
							<div class="vbo-dashboard-guest-activity-content-info-details">
								...
								if (!strcasecmp((string) $booking['type'], 'overbooking')) {
									?>
									<span class="label label-error vbo-label-overbooking"><?php echo JText::_('VBO_BTYPE_' . strtoupper($booking['type'])); ?></span>
									<?php
								}
								if ($booking['status'] == 'cancelled') {
									?>
									<span class="badge badge-danger"><?php echo JText::_('VBCANCELLED'); ?></span>
									<?php
								}
								?>
		...
		foreach ($all_cfields as $cfield) {
			if ($cfield['type'] == 'text' && $cfield['isphone'] == 1) {
				...
				<div class="vbo-calendar-cfield-entry">
					<label for="cfield<?php echo $cfield['id'] . $wrapper; ?>"><?php echo JText::_($cfield['name']); ?></label>
					<span>
						<?php
	...
	public function saveBooking()
	{
		...
		if (empty($room_id) || empty($checkin) || empty($checkout)) {
			VBOHttpDocument::getInstance()->close(500, JText::_('VBO_PLEASE_FILL_FIELDS'));
		}
		...
		if (!$checkin_ts || !$checkout_ts || $checkin_ts >= $checkout_ts) {
			VBOHttpDocument::getInstance()->close(500, JText::_('ERRINVDATESEASON'));
		}
				...
				<div class="vbo-widget-booskcal-inner">
					...
					<div class="vbo-widget-booskcal-top-wrap">
						...
						<div class="vbo-widget-booskcal-newbook">
							<button type="button" class="btn btn-primary vbo-widget-booskcal-newbook-start" onclick="vboWidgetBookCalsNewBooking('<?php echo $wrapper_id; ?>');"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBO_NEW_BOOKING'); ?></button>
			...
			jQuery(function() {
				...
				if (typeof jQuery.fn.select2 !== 'undefined' && <?php echo $use_nice_select; ?>) {
					jQuery('#<?php echo $wrapper_id; ?>').find('select.vbo-booskcal-roomid').select2({
						width: "100%",
						placeholder: "<?php echo htmlspecialchars(VikBooking::strTrimLiteral(JText::_('VBOREPORTSROOMFILT'))); ?>",
						allowClear: true,
