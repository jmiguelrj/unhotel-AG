...
class VikBookingAdminWidgetLastReservations extends VikBookingAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VBO_W_LASTRES_TITLE');
		$this->widgetDescr = JText::_('VBO_W_LASTRES_DESCR');
	...
	public function render(?VBOMultitaskData $data = null)
	{
		...
		<div class="vbo-admin-widget-wrapper">
			<div class="vbo-admin-widget-head">
				<h4><?php VikBookingIcons::e('far fa-bell'); ?> <span><?php echo JText::_('VBDASHLASTRES'); ?></span></h4>
			</div>
				...
				<table class="table">
					...
					foreach ($lastreservations as $nbk => $next) {
						...
						if ($next['roomsnum'] == 1) {
							...
							$roomstr = '<span class="vbo-tooltip vbo-tooltip-top" data-tooltiptext="' . JHtml::_('esc_attr', implode(', ', $room_names)) . '">'.$next['roomsnum'].'</span>';
						}
