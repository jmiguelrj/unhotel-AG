...
class VikBookingAdminWidgetVisitorsCounter extends VikBookingAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VBO_W_VISITCOUNT_TITLE');
		$this->widgetDescr = JText::_('VBO_W_VISITCOUNT_DESCR');
		...
		<div class="vbo-admin-widget-wrapper">
			...
			<div id="<?php echo $wrapper_id; ?>" class="vbo-widget-visitscounter-wrap">
				<div class="vbo-widget-visitscounter-number">
					...
					<div class="vbo-widget-visitscounter-number-lbl"><?php echo JText::_('VBO_W_VISITCOUNT_VTODAY'); ?></div>
				</div>
				<div class="vbo-widget-visitscounter-number">
					<span class="vbo-widget-visitscounter-number-count" data-period="tot_month">0</span>
					<div class="vbo-widget-visitscounter-number-lbl"><?php echo JText::_('VBO_W_VISITCOUNT_VTMON'); ?></div>
				</div>
				<div class="vbo-widget-visitscounter-number">
					<span class="vbo-widget-visitscounter-number-count" data-period="tot_last_month">0</span>
					<div class="vbo-widget-visitscounter-number-lbl"><?php echo JText::_('VBO_W_VISITCOUNT_VLMON'); ?></div>
				</div>
				<div class="vbo-widget-visitscounter-number">
					<span class="vbo-widget-visitscounter-number-count" data-period="pcent_month">0 %</span>
					<div class="vbo-widget-visitscounter-number-lbl"><?php echo JText::_('VBO_W_VISITCOUNT_VDIFF'); ?></div>
				</div>
			</div>
		</div>
		<?php
