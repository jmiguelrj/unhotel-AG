...
class VikBookingAdminWidgetBulkMessaging extends VikBookingAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VBO_W_BULKMESSAGING_TITLE');
		$this->widgetDescr = JText::_('VBO_W_BULKMESSAGING_DESCR');
	...
	public function loadBookings()
	{
		...
		if (!$bookings) {
			...
			foreach ($bookings as $ind => $booking) {
				...
				if ($booking['closure'] > 0 || !strcasecmp($booking['custdata'], JText::_('VBDBTEXTROOMCLOSED'))) {
						...
						<div class="vbo-dashboard-guest-activity-content-head">
							<div class="vbo-dashboard-guest-activity-content-info-details">
								...
								if ($booking['status'] == 'cancelled') {
									...
									?>
									<span class="badge badge-warning"><?php echo JText::_('VBSTANDBY'); ?></span>
									<?php
								}
								?>
								...
								if ($last_notified) {
									?>
									<span class="vbo-widget-bulkmess-notified vbo-tooltip vbo-tooltip-top" data-tooltiptext="<?php echo JHtml::_('esc_attr', JText::_('VBOBOOKHISTORYTCE')); ?>"><?php VikBookingIcons::e('envelope'); ?> <?php echo JHtml::_('date', $hist['dt'], 'Y-m-d H:i:s'); ?></span>
									<?php
								}
								?>
								</div>
	...
	public function sendOneMessage()
	{
		...
		if (!$booking) {
			VBOHttpDocument::getInstance()->close(500, JText::_('VBPEDITBUSYONE'));
		}
				...
				<div class="vbo-widget-bulkmess-steps">
					...
					<div class="vbo-widget-bulkmess-step vbo-widget-bulkmess-step-search">
						<div class="vbo-widget-bulkmess-step-title" onclick="vboWidgetBulkMessToggleStep('<?php echo $wrapper_id; ?>', 'search');">
							<h4><?php VikBookingIcons::e('calendar'); ?> <?php echo JText::_('VBODASHSEARCHKEYS'); ?></h4>
								...
								<div class="vbo-params-wrap">
									<div class="vbo-params-container">
										...
										<div class="vbo-param-container">
											...
											<div class="vbo-param-setting">
												<select class="vbo-widget-bulkmess-type">
													<option value="stayover"><?php echo JText::_('VBOTYPESTAYOVER'); ?></option>
													<option value="arrival"><?php echo JText::_('VBOTYPEARRIVAL'); ?></option>
													<option value="departure"><?php echo JText::_('VBOTYPEDEPARTURE'); ?></option>
													<option value="bookdate"><?php echo JText::_('VBPEDITBUSYTWO'); ?></option>
												</select>
											</div>
										</div>
										...
										<div class="vbo-param-container vbo-param-confirm-btn">
											...
											<div class="vbo-param-setting">
												<button type="button" class="btn btn-primary vbo-btn-wide vbo-widget-bulkmess-loadbtn" onclick="vboWidgetBulkMessLoadBookings('<?php echo $wrapper_id; ?>');"><span><?php echo JText::_('VBJQCALNEXT'); ?></span> <?php VikBookingIcons::e('chevron-right'); ?></button>
											</div>
										</div>
					...
					<div class="vbo-widget-bulkmess-step vbo-widget-bulkmess-step-hidden vbo-widget-bulkmess-step-bookings">
						<div class="vbo-widget-bulkmess-step-title" onclick="vboWidgetBulkMessToggleStep('<?php echo $wrapper_id; ?>', 'bookings');">
							<h4><?php VikBookingIcons::e('users'); ?> <?php echo JText::_('VBMENUCUSTOMERS'); ?></h4>
							<span class="vbo-widget-bulkmess-step-status"></span>
						</div>
						<div class="vbo-widget-bulkmess-step-content">
							<div class="vbo-widget-bulkmess-bookings-actions">
								<button type="button" class="btn btn-small" onclick="vboWidgetBulkMessSelectAll('<?php echo $wrapper_id; ?>');"><?php echo JText::_('VBINVSELECTALL'); ?></button>
							</div>
							...
							<div class="vbo-widget-bulkmess-gonext" style="display: none;">
								<button type="button" class="btn btn-primary vbo-btn-wide" onclick="vboWidgetBulkMessGoNext('<?php echo $wrapper_id; ?>', 'message');"><span><?php echo JText::_('VBJQCALNEXT'); ?></span> <?php VikBookingIcons::e('chevron-right'); ?></button>
							</div>
						</div>
					</div>
					...
					<div class="vbo-widget-bulkmess-step vbo-widget-bulkmess-step-hidden vbo-widget-bulkmess-step-message">
						<div class="vbo-widget-bulkmess-step-title" onclick="vboWidgetBulkMessToggleStep('<?php echo $wrapper_id; ?>', 'message');">
							<h4><?php VikBookingIcons::e('envelope'); ?> <?php echo JText::_('VBSENDEMAILCUSTCONT'); ?></h4>
							<span class="vbo-widget-bulkmess-step-status"></span>
						</div>
						<div class="vbo-widget-bulkmess-step-content">
							<div class="vbo-admin-container vbo-admin-container-full vbo-admin-container-compact">
								<div class="vbo-params-wrap">
									<div class="vbo-params-container">
										...
										<div class="vbo-param-container">
											<div class="vbo-param-label"><?php echo JText::_('VBSENDEMAILCUSTSUBJ'); ?></div>
											<div class="vbo-param-setting">
												<input type="text" class="vbo-widget-bulkmess-subject" value="<?php echo JHtml::_('esc_attr', $def_subject); ?>" autocomplete="off" />
											</div>
										</div>
							...
							<div class="vbo-widget-bulkmess-gonext">
								<button type="button" class="btn btn-primary vbo-btn-wide" onclick="vboWidgetBulkMessGoNext('<?php echo $wrapper_id; ?>', 'send');"><span><?php echo JText::_('VBO_SEND'); ?></span> <?php VikBookingIcons::e('chevron-right'); ?></button>
							</div>
						</div>
					</div>
					...
					<div class="vbo-widget-bulkmess-step vbo-widget-bulkmess-step-hidden vbo-widget-bulkmess-step-send">
						<div class="vbo-widget-bulkmess-step-title" onclick="vboWidgetBulkMessToggleStep('<?php echo $wrapper_id; ?>', 'send');">
							<h4><?php VikBookingIcons::e('rocket'); ?> <?php echo JText::_('VBO_SEND_MESSAGES'); ?></h4>
							<span class="vbo-widget-bulkmess-step-status"></span>
						</div>
						<div class="vbo-widget-bulkmess-step-content">
