...
class VikBookingConditionalRuleOptions extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBOREPORTOPTIONSEXTRAS');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_OPTS_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBOREPORTOPTIONSEXTRAS'); ?></div>
