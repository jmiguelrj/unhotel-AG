...
class VikBookingConditionalRuleRequestPayment extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBO_AMOUNT_PAYABLE_RQ');
		$this->ruleDescr = sprintf('%s (%s)', JText::_('VBO_AMOUNT_PAYABLE_RQ'), JText::_('VBO_AMOUNT_PAYABLE'));
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBO_AMOUNT_PAYABLE_RQ'); ?></div>
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('has_amount_payable'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('has_amount_payable', 0), 1, 0); ?>
