...
class VikBookingConditionalRuleWeekDays extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBSEASONDAYS');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_WDAYS_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBPVIEWCUSTOMFTWO'); ?></div>
			<div class="vbo-param-setting">
				<select name="<?php echo $this->inputName('type'); ?>" id="<?php echo $this->inputID('type'); ?>">
					<option value=""></option>
					<option value="checkin"<?php echo $this->getParam('type', '') == 'checkin' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBPICKUPAT'); ?></option>
					<option value="checkout"<?php echo $this->getParam('type', '') == 'checkout' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBRELEASEAT'); ?></option>
					<option value="both"<?php echo $this->getParam('type', '') == 'both' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBPICKUPAT') . ' | ' . JText::_('VBRELEASEAT'); ?></option>
				</select>
			</div>
		</div>
