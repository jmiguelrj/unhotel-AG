...
class VikBookingConditionalRuleBookingStatus extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBCALBOOKINGSTATUS');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_BOOKSTAT_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBSTATUS'); ?></div>
	...
	{
		return array(
			'confirmed' => JText::_('VBCONFIRMED'),
			'standby' => JText::_('VBSTANDBY'),
			'cancelled' => JText::_('VBCANCELLED'),
		);
	}
