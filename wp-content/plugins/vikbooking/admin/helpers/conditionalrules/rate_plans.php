...
class VikBookingConditionalRuleRatePlans extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBMENURATEPLANS');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_RPL_DESCR');
	...
	public function renderParams()
	{
		...
		if (count($otarplans)) {
			...
			?>
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBMENUCHANNELMANAGER'); ?></div>
			<div class="vbo-param-setting">
