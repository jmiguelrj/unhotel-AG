...
class VikBookingConditionalRuleRooms extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBPVIEWORDERSTHREE');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_ROOMS_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			...
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('use_sub_units'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('use_sub_units', 0), 1, 0, 'vboToggleUseSubUnits();'); ?>
			</div>
		</div>
			<?php
