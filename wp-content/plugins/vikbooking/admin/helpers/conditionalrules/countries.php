...
class VikBookingConditionalRuleCountries extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBO_CONDTEXT_RULE_COUNTRIES');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_COUNTRIES_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBO_CONDTEXT_RULE_COUNTRIES'); ?></div>
