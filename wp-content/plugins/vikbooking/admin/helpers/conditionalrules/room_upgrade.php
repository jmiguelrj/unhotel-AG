...
class VikBookingConditionalRuleRoomUpgrade extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBO_ROOM_UPGRADE');
		$this->ruleDescr = JText::_('VBO_ROOM_UPGRADE_CONDTEXT_H');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBO_ROOM_UPGRADE'); ?></div>
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('can_upgrade'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('can_upgrade', 0), 1, 0); ?>
				<span class="vbo-param-setting-comment"><?php echo JText::_('VBO_ROOM_UPGRADE_CONDTEXT_H'); ?></span>
			</div>
		</div>
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBO_ROOM_UPGRADE_ADDCONTMSG'); ?></div>
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('add_details'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('add_details', 0), 1, 0); ?>
				<span class="vbo-param-setting-comment"><?php echo JText::_('VBO_CONDTEXT_MSG') . ' - ' . JText::_('VBO_CONDTEXT_TKN') . ': '; ?><span onclick="vboRoomUpgradeAddContentEditor('{room_upgrade}');" style="cursor: pointer;">{room_upgrade}</span></span>
			</div>
		</div>
		...
		<div style="margin: 4px 0; padding: 6px;">
			...
			<div style="display: inline-block; margin: 4px; padding: 4px; border: 1px solid #ddd; border-radius: 6px; vertical-align: top; width: 100%; box-sizing: border-box;">
				...
				<div style="margin: 8px 0 0 2%;float: left;">
					<a href="<?php echo $booking_link; ?>" target="_blank" style="padding: 4px 6px; border: 1px solid #ddd; border-radius: 4px; background-color: <?php echo $btnlink_bgc; ?>; color: <?php echo $btnlink_col; ?>; text-decoration: none; font-weight:bold; display: inline-block;"><?php echo JText::_('VBO_UPGRADE_CONFIRM'); ?></a>
				</div>
			</div>
				<?php
			}
