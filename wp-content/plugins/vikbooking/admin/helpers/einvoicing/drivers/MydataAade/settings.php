	...
	<table cellspacing="1" class="admintable table">
		<tbody>
			<tr>
				...
				<td><?php echo $vbo_app->printYesNoButtons('automatic', JText::_('VBYES'), JText::_('VBNO'), (int)$data['automatic'], 1, 0); ?></td>
			</tr>
			<tr>
				<td width="200" class="vbo-config-param-cell"> 
			...
			<tr>
				...
				<td><?php echo $vbo_app->printYesNoButtons('schema_validate', JText::_('VBYES'), JText::_('VBNO'), (isset($data['params']) && !empty($data['params']['schema_validate']) ? 1 : 0), 1, 0); ?></td>
			</tr>
			<?php
			...
			<tr>
				...
				<td><?php echo $vbo_app->printYesNoButtons('environmental_invoice', JText::_('VBYES'), JText::_('VBNO'), ($gen_env_invoice ? 1 : 0), 1, 0, 'mydataToggleSettings(this.checked, \'environmental-invoice\');'); ?></td>
			</tr>
	...
	<table cellspacing="1" class="admintable table">
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo $vbo_app->printYesNoButtons('test_mode', JText::_('VBYES'), JText::_('VBNO'), (isset($data['params']) && !empty($data['params']['test_mode']) ? 1 : 0), 1, 0); ?>
				</td>
			</tr>
		</tbody>
	</table>
...
<fieldset class="vbo-driver-fieldset">
	<legend class="adminlegend"><?php echo JText::_('VBSEPDRIVERD'); ?> (Issuer)</legend>
	<table cellspacing="1" class="admintable table">
		<tbody>
			<tr>
				<td width="200" class="vbo-config-param-cell"> 
					<b><?php echo JText::_('VBCONFIGTHREEONE'); ?></b> 
					<?php echo $vbo_app->createPopover(array('title' => JText::_('VBCONFIGTHREEONE'), 'content' => 'The issuer name value, hence your company name.')); ?>
				</td>
			...
			<tr>
				<td width="200" class="vbo-config-param-cell"> 
					<b><?php echo JText::_('ORDER_STATE'); ?> (2-char code)</b> 
			...
			<tr>
				<td width="200" class="vbo-config-param-cell"> <b><?php echo JText::_('ORDER_ADDRESS'); ?></b> </td>
			...
			<tr>
				<td width="200" class="vbo-config-param-cell"> <b><?php echo JText::_('ORDER_ZIP'); ?></b> </td>
				<td><input type="text" name="zip" value="<?php echo isset($data['params']) && !empty($data['params']['zip']) ? $data['params']['zip'] : ''; ?>" size="30" /></td>
			</tr>
			<tr>
				<td width="200" class="vbo-config-param-cell"> <b><?php echo JText::_('ORDER_CITY'); ?></b> </td>
