	...
	public static function printHeader($highlight = "")
	{
		...
		<div class="vbo-menu-container<?php echo $view == 'dashboard' ? ' vbo-menu-container-closer' : ''; ?>">
			...
			<div class="vbo-menu-right">
				<ul class="vbo-menu-ul">
					...
					?><li class="vbo-menu-parent-li">
						<span><?php VikBookingIcons::e('cogs'); ?><a><?php echo JText::_('VBMENUFOUR'); ?> <?php VikBookingIcons::e('chevron-down', 'vbo-submenu-chevron'); ?></a></span>
								...
								<li>
									<div class="<?php echo ($highlight == "14" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=payments">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTENEIGHT'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li>
									<div class="<?php echo ($highlight == "16" || $highlight == 'states' || $highlight == 'managestate' ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=customf">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTENTEN'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li>
									<div class="<?php echo ($highlight == "21" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=translations">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTRANSLATIONS'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li>
									<div class="<?php echo ($highlight == "11" || $highlight == 'backups' || $highlight == 'overrides' ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=config">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTWELVE'); ?></span>
											</span>
										</a>
									</div>
								</li>
					...
					?><li class="vbo-menu-parent-li">
						<span><?php VikBookingIcons::e('briefcase'); ?><a><?php echo JText::_('VBMENURATEPLANS'); ?> <?php VikBookingIcons::e('chevron-down', 'vbo-submenu-chevron'); ?></a></span>
						<div class="vbo-submenu-wrap">
								...
								<li>
									<div class="<?php echo ($highlight == "2" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=iva">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUNINE'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "1" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=prices">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUFIVE'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "17" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=coupons">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUCOUPONS'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "packages" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=packages">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUPACKAGES'); ?></span>
											</span>
										</a>
									</div>
								</li>
					...
					?><li class="vbo-menu-parent-li">
						<span><?php VikBookingIcons::e('bed'); ?><a><?php echo JText::_('VBMENUTWO'); ?> <?php VikBookingIcons::e('chevron-down', 'vbo-submenu-chevron'); ?></a></span>
						<div class="vbo-submenu-wrap">
								...
								<li>
									<div class="<?php echo ($highlight == "4" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=categories">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUSIX'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li>
									<div class="<?php echo ($highlight == "5" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=carat">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTENFOUR'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li>
									<div class="<?php echo ($highlight == "6" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=optionals">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTENFIVE'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li>
									<div class="<?php echo ($highlight == "7" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=rooms">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTEN'); ?></span>
											</span>
										</a>
									</div>
								</li>
					...
					if ($vbo_auth_pricing) {
					?><li class="vbo-menu-parent-li">
						<span><i class="vboicn-calculator"></i><a><?php echo JText::_('VBMENUFARES'); ?> <?php VikBookingIcons::e('chevron-down', 'vbo-submenu-chevron'); ?></a></span>
						<div class="vbo-submenu-wrap">
								...
								<li>
									<div class="<?php echo ($highlight == "fares" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=tariffs">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUPRICESTABLE'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "13" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=seasons">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTENSEVEN'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "restrictions" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=restrictions">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENURESTRICTIONS'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "20" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=ratesoverv">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENURATESOVERVIEW'); ?></span>
											</span>
										</a>
									</div>
								</li>
					...
					?><li class="vbo-menu-parent-li">
						<span><?php VikBookingIcons::e('calendar-check'); ?><a><?php echo JText::_('VBMENUTHREE'); ?> <?php VikBookingIcons::e('chevron-down', 'vbo-submenu-chevron'); ?></a></span>
						<div class="vbo-submenu-wrap">
								...
								<li>
									<div class="<?php echo (in_array($highlight, ['18', 'shortcodes', 'acl', 'gotopro']) ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUDASHBOARD'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li>
									<div class="<?php echo ($highlight == "19" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=calendar">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUQUICKRES'); ?></span>
											</span>
										</a>
										</div>
									</li>
								...
								<li>
									<div class="<?php echo ($highlight == "15" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=overv">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTENNINE'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li>
									<div class="<?php echo ($highlight == "8" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=orders">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUSEVEN'); ?></span>
											</span>
										</a>
									</div>
								</li>
								...
								<li class="vbo-menu-vcm-only">
									<div class="<?php echo ($highlight == 'vikchannelmanager' ? 'vmenulinkactive' : 'vmenulink'); ?>">
										<a href="index.php?option=com_vikchannelmanager" class="vbo-menu-vcmlink">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUCHANNELMANAGER'); ?></span>
											</span>
										</a>
									</div>
								</li>
					...
					?><li class="vbo-menu-parent-li">
						<span><?php VikBookingIcons::e('chart-pie'); ?><a><?php echo JText::_('VBMENUMANAGEMENT'); ?> <?php VikBookingIcons::e('chevron-down', 'vbo-submenu-chevron'); ?></a></span>
						<div class="vbo-submenu-wrap">
								...
								<li>
									<div class="<?php echo ($highlight == "22" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=customers">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUCUSTOMERS'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "invoices" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=invoices">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUINVOICES'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "stats" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=stats">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUSTATS'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "trackings" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=trackings">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTRACKINGS'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo (in_array($highlight, ["crons", "managecron"]) ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;view=crons">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUCRONS'); ?></span>
											</span>
										</a>
									</div>
								</li>
					...
					?><li class="vbo-menu-parent-li">
						<span><?php VikBookingIcons::e('tasks'); ?><a><?php echo JText::_('VBMENUPMS'); ?> <?php VikBookingIcons::e('chevron-down', 'vbo-submenu-chevron'); ?></a></span>
						<div class="vbo-submenu-wrap">
								...
								?><li>
									<div class="<?php echo ($highlight == "operators" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=operators">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUOPERATORS'); ?></span>
											</span>
										</a>
									</div>
								</li>
								<li>
									<div class="<?php echo ($highlight == "tableaux" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=tableaux">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUTABLEAUX'); ?></span>
											</span>
										</a>
									</div>
								</li><?php
								...
								?><li>
									<div class="<?php echo ($highlight == "pmsreports" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=pmsreports">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUPMSREPORTS'); ?></span>
											</span>
										</a>
									</div>
								</li><?php
								...
								?><li>
									<div class="<?php echo ($highlight == "einvoicing" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;task=einvoicing">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBMENUEINVOICING'); ?></span>
											</span>
										</a>
									</div>
								</li><?php
								...
								?><li class="vbo-menu-vcm-only">
									<div class="<?php echo ($highlight == "taskmanager" ? "vmenulinkactive" : "vmenulink"); ?>">
										<a href="index.php?option=com_vikbooking&amp;view=taskmanager">
											...
											<span class="vbo-submenu-item">
												<span class="vbo-submenu-item-txt"><?php echo JText::_('VBO_TASK_MANAGER'); ?></span>
											</span>
										</a>
									</div>
								</li><?php
			...
			if (VBOPlatformDetection::isWordPress()) {
				...
				if (!VikBookingLicense::isPro()) {
					?>
						<button type="button" class="vbo-gotopro" title="<?php echo addslashes(JText::_('VBOGOTOPROBTN')); ?>" onclick="document.location.href='admin.php?option=com_vikbooking&view=gotopro';">
							<?php VikBookingIcons::e('rocket'); ?>
							<span><?php echo JText::_('VBOGOTOPROBTN'); ?></span>
						</button>
					<?php
				} else {
					?>
						<button type="button" class="vbo-alreadypro" title="<?php echo addslashes(JText::_('VBOISPROBTN')); ?>" onclick="document.location.href='admin.php?option=com_vikbooking&view=gotopro';">
							<?php VikBookingIcons::e('trophy'); ?>
							<span><?php echo JText::_('VBOISPROBTN'); ?></span>
						</button>
					<?php
				}
			} else {
					...
					if (count($callable) && $callable[0]) {
						...
						echo JHtml::_(
							...
							array(
								...
								'bodyHeight'  => 80,
								'url'         => $vikupdater_url,
								'footer'      => '<button type="button" class="btn btn-success" id="version-check-install">' . JText::_('JTOOLBAR_INSTALL') . '</button>',
							)
						);
						?>
							...
							(function($) {
								...
								$(function() {
									...
									$('#version-check-install').on('click', () => {
										...
										form.append('<?php echo JHtml::_('form.token'); ?>');
			...
			if ($vbo_auth_management && in_array($highlight, array('18', '11'))) {
				...
				if (!is_null($opp)) {
					...
					if ($new_opp_count > 0) {
						?>
					<!-- <button type="button" class="vbo-opportunities-btnbadge" data-opportunity-count="<?php echo $new_opp_count; ?>" title="<?php echo htmlspecialchars(JText::_('VBOGOTOOPPORTUNITIES')); ?>" onclick="document.location.href='<?php echo VBOFactory::getPlatform()->getUri()->admin('index.php?option=com_vikchannelmanager&task=opportunities', false); ?>';">
						<?php VikBookingIcons::e('crown'); ?>
						<span><?php echo JText::_('VBOGOTOOPPORTUNITIES'); ?></span>
					</button> -->
						<?php
					}
				}
				...
				if ($highlight == '18') {
					?>
					<button type="button" class="vbo-reviews-btnbadge" data-reviews-count="" title="<?php echo htmlspecialchars(JText::_('VBOPANELREVIEWS')); ?>" onclick="<?php echo $reviews_dld >= 0 ? "window.open('{$base_lnk}', '_blank'); jQuery(this).removeClass('vbo-reviews-btnbadge-alert').attr('data-reviews-count', '');" : "alert(Joomla.JText._('VBOGUESTREVSVCMREQ'));"; ?>">
						<?php VikBookingIcons::e('star'); ?>
						<span><?php echo JText::_('VBOPANELREVIEWS'); ?></span>
					</button>
					<?php
				}
			}
			...
			if ($view != 'dashboard') {
				?>
					<button type="button" class="vbo-multitasking-apps" title="<?php echo htmlspecialchars(JText::_('VBO_MULTITASK_PANEL'), ENT_QUOTES, 'UTF-8'); ?>">
			...
			?>
					<div class="vbo-notifications-center-container">
						<button type="button" class="vbo-notifications-center-handler" data-badge-count="<?php echo $unreadNotifs; ?>" data-badge-read="<?php echo $unreadNotifsRead; ?>" title="<?php echo htmlspecialchars(JText::_('VBO_W_NOTIFSCENTER_TITLE'), ENT_QUOTES, 'UTF-8'); ?>">
		...
		<div class="vbo-info-overlay-block vbo-info-overlay-expiration-reminder">
			<div class="vbo-info-overlay-content">
				<h3 style="color: var(--vbo-red-color);"><i class="vboicn-warning"></i> <?php echo JText::_('VCM_EXPIRATION_REMINDERS'); ?></h3>
				<div>
				...
				<div class="vbo-info-overlay-footer">
					<div class="vbo-info-overlay-footer-right">
						<button type="button" class="btn btn-danger" onclick="jQuery('.vbo-info-overlay-expiration-reminder').fadeOut();"><?php echo JText::_('VBOBTNKEEPREMIND'); ?></button>
					</div>
				</div>
			</div>
		</div>
		...
		JHtml::_('script', VBO_ADMIN_URI . 'resources/helpwizard.js', ['version' => VIKBOOKING_SOFTWARE_VERSION]);
		JText::script('VBSAVE');
