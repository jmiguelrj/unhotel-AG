...
<div class="vbo-dashboard-firstsetup-sampledata-wrap" style="display: none;">
	<div class="vbo-dashboard-firstsetup-sampledata-inner">
		<h4>
			<span><?php echo JText::_('VBODASHINSTSAMPLEDTXT'); ?></span>
			<a class="btn vbo-sampledata-btn" href="admin.php?option=com_vikbooking&view=sampledata"><?php VikBookingIcons::e('hat-wizard'); ?> <?php echo JText::_('VBODASHINSTSAMPLEDBTN'); ?></a>
		</h4>
	</div>
</div>
