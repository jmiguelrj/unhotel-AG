...
if (!$this->setup_completed) {
	// no rooms in VBO
	?>
<p class="warn"><?php echo JText::_('VBO_IMPBFTPP_NOVBOROOMS'); ?></p>
<form action="index.php?option=com_vikbooking" method="post" name="adminForm" id="adminForm">
	...
	?>
<p class="info vbo-importbftpp-disclaimer"><?php echo JText::_('VBO_IMPBFTPP_DISCLAIMER'); ?></p>
<form action="index.php?option=com_vikbooking&view=importbftpp" method="post" name="adminForm" id="adminForm" class="vbo-list-form" onsubmit="return vboImportbftppSubmit();">
	...
	if (!is_array($this->plugins) || !count($this->plugins)) {
		?>
	<p class="err"><?php echo JText::_('VBO_IMPBFTPP_NOPLUGINS'); ?></p>
	<a class="btn btn-primary" href="index.php?option=com_vikbooking"><?php echo JText::_('VBBACK'); ?></a>
		<?php
	} else {
		?>
	<div class="vbo-importbftpp-plugins-list">
		<div class="vbo-importbftpp-plugins-list-inner">
			<label for="vbo-importbftpp-plugins-sel"><?php echo JText::_('VBO_IMPBFTPP_AVAILPLUGINS'); ?></label>
		...
		<div class="vbo-importbftpp-plugins-list-bottom">
			<span class="vbo-btn-label"><?php echo JText::_('VBO_IMPBFTPP_READBFROMP'); ?></span>
			<button type="submit" class="btn btn-primary"><?php VikBookingIcons::e('search'); ?> <?php echo JText::_('VBO_IMPBFTPP_READBFROMP_SHORT'); ?></button>
		</div>
	</div>
		<?php
	...
	<div class="vbo-importbftpp-roomsmapping-wrap">
		<p class="info vbo-importbftpp-roomsmapping-info"><?php echo JText::_('VBO_IMPBFTPP_MAKERMAPPING'); ?></p>
		<h4 class="vbo-importbftpp-subtitle">1. <?php echo JText::_('VBO_IMPBFTPP_MAKERMAPPING_SHORT'); ?></h4>
		<div class="vbo-importbftpp-roomsmapping-inner">
			...
			<div class="vbo-importbftpp-roomsmapping-block">
				<div class="vbo-importbftpp-roomsmapping-block-thirdparty">
					<label for="vbo-importbftpp-tpproom<?php echo $tprid; ?>"><?php echo JText::_('VBO_IMPBFTPP_SELTPPROOM'); ?></label>
				...
				<div class="vbo-importbftpp-roomsmapping-block-vbo">
					<label for="vbo-importbftpp-vboroom<?php echo $tprid; ?>"><?php echo JText::_('VBO_IMPBFTPP_SELVBOROOM'); ?></label>
	...
	<h4 class="vbo-importbftpp-subtitle">2. <?php echo JText::_('VBO_IMPBFTPP_SELRES_SHORT'); ?></h4>
	<div class="vbo-importbftpp-reservations-wrap">
		<div class="vbo-importbftpp-reservations-btns" style="display: none;">
			<span class="vbo-importbftpp-reservations-btn">
				<button type="button" class="btn btn-success" onclick="vboToggleAllResImport(true);"><?php echo JText::_('VBINVSELECTALL'); ?></button>
			</span>
			<span class="vbo-importbftpp-reservations-btn">
				<button type="button" class="btn btn-danger" onclick="vboToggleAllResImport(false);"><?php echo JText::_('VBINVDESELECTALL'); ?></button>
			</span>
		</div>
				...
				<div class="vbo-importbftpp-reservation-inner vbo-importbftpp-reservation-noteligible" data-tprooms="<?php echo implode(';', $tpbdata['room_ids']); ?>">
					<div class="vbo-importbftpp-reservation-details">
						<div class="vbo-importbftpp-reservation-detail">
							<span class="vbo-importbftpp-reservation-detail-lbl"><?php echo JText::_('VBDASHBOOKINGID'); ?></span>
							<span class="label vbo-importbftpp-reservation-detail-val"><?php echo '#' . $tpbid . ' (' . $tpbdata['dt'] . ')'; ?></span>
						</div>
						<div class="vbo-importbftpp-reservation-detail">
							<span class="vbo-importbftpp-reservation-detail-lbl"><?php echo JText::_('VBSTATUS'); ?></span>
					...
					if (!empty($tpbdata['infos']['first_name'])) {
						?>
						<div class="vbo-importbftpp-reservation-detail">
							<span class="vbo-importbftpp-reservation-detail-lbl"><?php echo JText::_('VBCUSTOMERFIRSTNAME'); ?></span>
					...
					if (!empty($tpbdata['infos']['last_name'])) {
						?>
						<div class="vbo-importbftpp-reservation-detail">
							<span class="vbo-importbftpp-reservation-detail-lbl"><?php echo JText::_('VBCUSTOMERLASTNAME'); ?></span>
					...
					if (!empty($tpbdata['infos']['email'])) {
						?>
						<div class="vbo-importbftpp-reservation-detail">
							<span class="vbo-importbftpp-reservation-detail-lbl"><?php echo JText::_('VBCUSTOMEREMAIL'); ?></span>
					...
					if (!empty($tpbdata['infos']['checkin'])) {
						?>
						<div class="vbo-importbftpp-reservation-detail">
							<span class="vbo-importbftpp-reservation-detail-lbl"><?php echo JText::_('VBPICKUPAT'); ?></span>
					...
					if (!empty($tpbdata['infos']['checkout'])) {
						?>
						<div class="vbo-importbftpp-reservation-detail">
							<span class="vbo-importbftpp-reservation-detail-lbl"><?php echo JText::_('VBRELEASEAT'); ?></span>
					...
					<div class="vbo-importbftpp-reservation-import">
						<div class="vbo-importbftpp-reservation-import-toggle" style="display: none;">
							<?php echo $vbo_app->printYesNoButtons("tpp_bids[{$tpbid}]", JText::_('VBYES'), JText::_('VBNO'), 0, 1, 0); ?>
						</div>
						<div class="vbo-importbftpp-reservation-import-rooms">
							<span class="vbo-importbftpp-reservation-detail-lbl"><?php echo JText::_('VBPVIEWORDERSTHREE'); ?></span>
	...
	<div class="vbo-importbftpp-confirm-wrap">
		<span class="vbo-btn-label"><?php echo JText::_('VBO_IMPBFTPP_DOIMPORT'); ?></span>
		<button type="submit" class="btn btn-large btn-success" onclick="return vboConfirmImport();"><?php VikBookingIcons::e('download'); ?> <?php echo JText::_('VBO_IMPBFTPP_DOIMPORT_SHORT'); ?></button>
	</div>
			<?php
			...
			?>
	<p class="err"><?php echo JText::_('VBO_IMPBFTPP_NORESINTPP'); ?></p>
	<a class="btn btn-primary" href="index.php?option=com_vikbooking"><?php echo JText::_('VBBACK'); ?></a>
			<?php
		}
	}
...
function vboConfirmImport() {
	if (confirm('<?php echo addslashes(JText::_('VBO_IMPBFTPP_DOIMPORT_CONF')); ?>')) {
