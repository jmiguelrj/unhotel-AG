		...
		<div style="width: 100%; display: inline-block;" class="btn-toolbar" id="filter-bar">
			<div class="btn-group pull-left">
				<select name="idcountry" id="idcountry" onchange="document.statesform.submit();">
					<option value=""><?php echo JText::_('VBNEWCUSTOMFCOUNTRY'); ?></option>
				<?php
			...
			<div class="btn-group pull-left input-append">
				<input type="text" name="statename" id="statename" value="<?php echo JHtml::_('esc_attr', $pstatename); ?>" size="40" placeholder="<?php echo JText::_('VBPVIEWROOMONE'); ?>"/>
				<button type="button" class="btn btn-secondary" onclick="document.statesform.submit();"><i class="icon-search"></i></button>
			</div>
			<div class="btn-group pull-left">
				<button type="button" class="btn btn-secondary" onclick="document.getElementById('statename').value='';document.getElementById('idcountry').value='';document.statesform.submit();"><?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?></button>
			</div>
		</div>
			...
			<thead>
				<tr>
					...
					<th class="title left" width="150">
						...
						<?php echo JText::_('VBO_STATE_PROVINCE') . ($this->orderby == "state_name" && $this->ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($this->orderby == "state_name" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
						</a>
					</th>
					<th class="title left" width="150"><?php echo JText::_( 'VBNEWCUSTOMFCOUNTRY' ); ?></th>
					<th class="title center" width="100" align="center">
						<a href="index.php?option=com_vikbooking&amp;view=states&amp;vborderby=state_3_code&amp;vbordersort=<?php echo ($this->orderby == "state_3_code" && $this->ordersort == "ASC" ? "DESC" : "ASC"); ?>" class="<?php echo ($this->orderby == "state_3_code" && $this->ordersort == "ASC" ? "vbo-list-activesort" : ($this->orderby == "state_3_code" ? "vbo-list-activesort" : "")); ?>">
							<?php echo JText::_('VBO_3CHAR_CODE').($this->orderby == "state_3_code" && $this->ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($this->orderby == "state_3_code" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
						</a>
					</th>
					<th class="title center" width="100" align="center">
						<a href="index.php?option=com_vikbooking&amp;view=states&amp;vborderby=state_2_code&amp;vbordersort=<?php echo ($this->orderby == "state_2_code" && $this->ordersort == "ASC" ? "DESC" : "ASC"); ?>" class="<?php echo ($this->orderby == "state_2_code" && $this->ordersort == "ASC" ? "vbo-list-activesort" : ($this->orderby == "state_2_code" ? "vbo-list-activesort" : "")); ?>">
							<?php echo JText::_('VBO_2CHAR_CODE').($this->orderby == "state_2_code" && $this->ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($this->orderby == "state_2_code" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
						</a>
					</th>
					<th class="title center" width="50" align="center">
						<a href="index.php?option=com_vikbooking&amp;view=states&amp;vborderby=published&amp;vbordersort=<?php echo ($this->orderby == "published" && $this->ordersort == "ASC" ? "DESC" : "ASC"); ?>" class="<?php echo ($this->orderby == "published" && $this->ordersort == "ASC" ? "vbo-list-activesort" : ($this->orderby == "published" ? "vbo-list-activesort" : "")); ?>">
							<?php echo JText::_('VBPSHOWPAYMENTSFIVE').($this->orderby == "published" && $this->ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($this->orderby == "published" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
						</a>
					</th>
				</tr>
			</thead>
