	...
	<div class="vbo-admin-container">
		<div class="vbo-config-maintab-left vbo-config-maintab-left-halfsize">
			<fieldset class="adminform">
				<div class="vbo-params-wrap">
					...
					<div class="vbo-params-container">
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBO_CONDTEXT_TKN'); ?></div>
							<div class="vbo-param-setting">
								...
								<span class="vbo-param-setting-comment"><?php echo JText::_('VBO_CONDTEXT_TKN_HELP'); ?></span>
							</div>
						</div>
					</div>
					<div class="vbo-param-container">
						<div class="vbo-param-label"><?php echo JText::_('VBO_CONDTEXT_DEBUG_RULES'); ?></div>
						<div class="vbo-param-setting">
							<?php echo $vbo_app->printYesNoButtons('debug', JText::_('VBYES'), JText::_('VBNO'), (count($this->condtext) ? (int)$this->condtext['debug'] : 0), 1, 0); ?>
							<span class="vbo-param-setting-comment"><?php echo JText::_('VBO_CONDTEXT_DEBUG_RULES_HELP'); ?></span>
						</div>
					</div>
					<div class="vbo-param-container vbo-param-container-full">
						<div class="vbo-param-label vbo-param-label-above"><?php echo JText::_('VBO_CONDTEXT_MSG'); ?></div>
						<div class="vbo-param-setting">
							<?php
							...
							?>
							<span class="vbo-param-setting-comment"><?php echo JText::_('VBO_CONDTEXT_MSG_HELP'); ?></span>
						</div>
					</div>
					<div class="vbo-params-container">
						<div class="vbo-param-container">
							<div class="vbo-param-setting">
								<p id="vbo-condtext-warn-norules" class="warn notice-noicon"<?php echo count($cond_text_rules) ? ' style="display: none;"' : ''; ?>><?php VikBookingIcons::e('info-circle'); ?> <?php echo JText::_('VBO_CONDTEXT_WARN_NORULES'); ?></p>
								<button type="button" class="btn vbo-config-btn" onclick="vboAddNewRule();"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBO_CONDTEXT_ADDRULE'); ?></button>
							</div>
						</div>
					</div>
				</div>
		...
		?>
			<div class="vbo-condtext-addrule-helper">
				<p id="vbo-condtext-warn-norules-scnd" class="warn notice-noicon"<?php echo count($cond_text_rules) ? ' style="display: none;"' : ''; ?>><?php VikBookingIcons::e('info-circle'); ?> <?php echo JText::_('VBO_CONDTEXT_WARN_NORULES'); ?></p>
				<button id="vbo-condtext-addrule-scnd" type="button" class="btn vbo-config-btn" onclick="vboAddNewRule();"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBO_CONDTEXT_ADDRULE'); ?></button>
			</div>
		</div>
...
<div class="vbo-modal-overlay-block vbo-modal-overlay-block-condtext">
	...
	<div class="vbo-modal-overlay-content vbo-modal-tall vbo-modal-overlay-content-condtext">
		<div class="vbo-modal-overlay-content-head vbo-modal-overlay-content-head-condtext">
			<h3><span><?php echo JText::_('VBO_CONDTEXT_ADDRULE'); ?></span> <span class="vbo-modal-overlay-close-times" onclick="hideVboModalCondtext();">&times;</span></h3>
		</div>
		...
		<div class="vbo-modal-overlay-content-footer">
			<div class="vbo-modal-overlay-content-footer-right">
				<button type="button" class="btn btn-success" onclick="vboAddRuleToDoc();"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBO_CONDTEXT_ADDRULE'); ?></button>
			</div>
		</div>
	</div>
</div>
