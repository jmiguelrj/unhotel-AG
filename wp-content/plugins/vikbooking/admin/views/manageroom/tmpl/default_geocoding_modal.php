...
<div class="vbo-modal-overlay-block vbo-modal-overlay-block-geomap">
	...
	<div class="vbo-modal-overlay-content vbo-modal-overlay-content-geomap">
		<div class="vbo-modal-overlay-content-head vbo-modal-overlay-content-head-geomap">
			<h3><span id="vbo-modal-geomap-title"><?php VikBookingIcons::e('map-marker-alt'); ?> <?php echo JText::_('VBO_GEO_CUSTOMIZE_MARKER') ?></span> <span class="vbo-modal-overlay-close-times" onclick="hideVboModalGeoMap();">&times;</span></h3>
		</div>
		<div class="vbo-modal-overlay-content-body vbo-modal-overlay-content-body-scroll">
			<div class="vbo-cust-geo-marker-wrapper" style="display: none;">
				<div class="vbo-cust-geo-marker-top">
					<label for="vbo-geo-marker-icntype"><?php echo JText::_('VBO_MARKER_ICN_TYPE'); ?></label>
					<select id="vbo-geo-marker-icntype" onchange="vboCustomizeMarkerChangeIconType(this.value);">
						<option value="google"><?php echo JText::_('VBO_MARKER_ICN_TYPE_GMAPS'); ?></option>
						<option value="symbol"><?php echo JText::_('VBO_MARKER_ICN_TYPE_SVG'); ?></option>
						<option value="icon"><?php echo JText::_('VBO_MARKER_ICN_TYPE_IMG'); ?></option>
					</select>
				</div>
				<div class="vbo-cust-geo-marker-bottom" style="display: none;" data-geomarker="symbol">
					...
					?>
						<div class="vbo-cust-geo-marker-svg vbo-cust-geo-marker-svg-addnew" data-markerapply="0" data-markerid="" onclick="vboCustomizeMarkerSelectSymbol(this);">
							<div class="vbo-cust-geo-marker-svg-name">
								<span><?php echo JText::_('VBO_ADD_NEW'); ?></span>
							</div>
							<div class="vbo-cust-geo-marker-svg-icon">
					...
					<div class="vbo-cust-geo-marker-svg-adjust" style="display: none;">
						<div class="vbo-geo-marker-param-container vbo-cust-geo-marker-svg-newfield" style="display: none;">
							<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_NEW_SVG_ICN_NAME'); ?></div>
						...
						<div class="vbo-geo-marker-param-container vbo-cust-geo-marker-svg-newfield" style="display: none;">
							<div class="vbo-geo-marker-param-label">
								<?php
								echo $vbo_app->createPopover(array('title' => JText::_('VBO_SVG_PATH'), 'content' => JText::_('VBO_SVG_PATH_HELP')));
								echo ' ' . JText::_('VBO_SVG_PATH');
								?>
							</div>
							<div class="vbo-geo-marker-param-setting">
						...
						<div class="vbo-geo-marker-param-container vbo-cust-geo-marker-svg-newfield" style="display: none;">
							<div class="vbo-geo-marker-param-setting">
								<button type="button" class="btn vbo-config-btn" onclick="vboCustomizeMarkerAddCustomSymbol();"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBCONFIGCLOSINGDATEADD'); ?></button>
								<button type="button" class="btn btn-secondary" onclick="vboCustomizeMarkerCancelCustomSymbol();"><?php VikBookingIcons::e('times-circle'); ?> <?php echo JText::_('VBANNULLA'); ?></button>
							</div>
						</div>
						<div class="vbo-geo-marker-param-container">
							<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_FILL_COLOR'); ?></div>
							<div class="vbo-geo-marker-param-setting">
						...
						<div class="vbo-geo-marker-param-container">
							<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_OPACITY'); ?></div>
							<div class="vbo-geo-marker-param-setting">
				...
				<div class="vbo-cust-geo-marker-bottom" style="display: none;" data-geomarker="icon">
					<div class="vbo-geo-marker-param-container">
						<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBPVIEWOPTIONALSSEVEN'); ?></div>
						<div class="vbo-geo-marker-param-setting">
							<?php echo $vbo_app->getMediaField('marker_icon_img', null); ?>
						</div>
					</div>
					<div class="vbo-geo-marker-param-container">
						<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_WIDTH'); ?></div>
						<div class="vbo-geo-marker-param-setting">
							<input type="number" id="vbo-geo-marker-icon-width" value="" min="0" step="1" /> px
						</div>
					</div>
					<div class="vbo-geo-marker-param-container">
						<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_HEIGHT'); ?></div>
						<div class="vbo-geo-marker-param-setting">
				...
				<div class="vbo-cust-geo-marker-save">
					<button type="button" class="btn btn-success" onclick="vboCustomizeMarkerApply();"><?php VikBookingIcons::e('check'); ?> <?php echo JText::_('VBAPPLY'); ?></button>
				</div>
			</div>
			<div class="vbo-cust-geo-overlay-wrapper" style="display: none;">
				<div class="vbo-cust-geo-overlay-inner">
					...
					<div class="vbo-geo-marker-param-container">
						<div class="vbo-geo-marker-param-setting">
							<p class="info notice-noicon"><?php echo JText::_('VBO_GEO_MAP_GOVERLAY_COORDS_HELP'); ?></p>
							<button type="button" id="vbo-overlay-copy-bounds" class="btn vbo-config-btn" onclick="vboOverlayCopyBounds();" style="display: none;"><?php echo VikBookingIcons::e('crop-alt'); ?> <?php echo JText::_('VBO_GEO_MAP_COPYBOUNDS'); ?></button>
						</div>
					</div>
					<div class="vbo-geo-marker-params-group">
						<div class="vbo-geo-marker-param-container">
							<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_COORD_SOUTH'); ?></div>
							<div class="vbo-geo-marker-param-setting">
						...
						<div class="vbo-geo-marker-param-container">
							<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_COORD_WEST'); ?></div>
							<div class="vbo-geo-marker-param-setting">
						...
						<div class="vbo-geo-marker-param-container">
							<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_COORD_NORTH'); ?></div>
							<div class="vbo-geo-marker-param-setting">
						...
						<div class="vbo-geo-marker-param-container">
							<div class="vbo-geo-marker-param-label"><?php echo JText::_('VBO_COORD_EAST'); ?></div>
							<div class="vbo-geo-marker-param-setting">
				...
				<div class="vbo-cust-geo-marker-save">
					<button type="button" class="btn btn-success" onclick="vboGroundOverlayApply();"><?php VikBookingIcons::e('check'); ?> <?php echo JText::_('VBAPPLY'); ?></button>
				</div>
			</div>
		</div>
	</div>
