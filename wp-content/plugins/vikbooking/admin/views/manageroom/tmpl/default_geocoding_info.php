	...
	<fieldset class="adminform">
		<div class="vbo-params-wrap">
			<legend class="adminlegend">
				<span class="vbo-geo-legend-title"><?php VikBookingIcons::e('map-marked-alt'); ?> <?php echo JText::_('VBO_GEO_INFO'); ?></span>
			<?php
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBO_ENABLE_GEOCODING'); ?></div>
					<div class="vbo-param-setting">
						<?php
						$geo_enabled = (int)$geo->getRoomGeoParams($rooms_params, 'enabled', 0);
						echo $vbo_app->printYesNoButtons('geo_enabled', JText::_('VBYES'), JText::_('VBNO'), $geo_enabled, 1, 0, 'vboToggleGeoParams();');
						?>
					</div>
				</div>
			<?php
			if (!$geo_supported) {
				...
				<div class="vbo-param-container vbo-geoinfo-param" style="<?php echo !$geo_enabled ? 'display: none;' : ''; ?>">
					<div class="vbo-param-setting">
						<p class="warn notice-noicon"><?php VikBookingIcons::e('exclamation-triangle'); ?> <?php echo JText::_('VBO_GEO_UNSUPPORTED'); ?></p>
					</div>
				</div>
				<?php
			} else {
				...
				<div class="vbo-param-container vbo-geoinfo-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_GEO_ADDRESS'); ?></div>
					<div class="vbo-param-setting">
				...
				<div class="vbo-param-container vbo-geoinfo-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_GEO_COORDS'); ?></div>
					<div class="vbo-param-setting">
						<span><?php echo JText::_('VBO_GEO_COORDS_LAT'); ?></span>
						...
						<span><?php echo JText::_('VBO_GEO_COORDS_LNG'); ?></span>
				...
				<div class="vbo-param-container vbo-geoinfo-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_GEO_ZOOM'); ?></div>
					<div class="vbo-param-setting">
						<input type="number" id="geo_zoom" min="0" step="any" value="<?php echo (int)$geo->getRoomGeoParams($rooms_params, 'zoom', 3); ?>" />
					</div>
				</div>
				<div class="vbo-param-container vbo-geoinfo-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_GEO_MTYPE'); ?></div>
					<div class="vbo-param-setting">
						<?php
						$geo_mtype = $geo->getRoomGeoParams($rooms_params, 'mtype', 'roadmap');
						?>
						<select id="geo_mtype">
							<option value="roadmap"<?php echo $geo_mtype == 'roadmap' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBO_GEO_MTYPE_ROADMAP'); ?></option>
							<option value="satellite"<?php echo $geo_mtype == 'satellite' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBO_GEO_MTYPE_SATELLITE'); ?></option>
							<option value="hybrid"<?php echo $geo_mtype == 'hybrid' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBO_GEO_MTYPE_HYBRID'); ?></option>
							<option value="terrain"<?php echo $geo_mtype == 'terrain' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBO_GEO_MTYPE_TERRAIN'); ?></option>
						</select>
					</div>
				</div>
				<div class="vbo-param-container vbo-geoinfo-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_GEO_MAP_HEIGHT'); ?></div>
					<div class="vbo-param-setting">
				...
				<div class="vbo-param-container vbo-geoinfo-param" style="display: none;">
					<div class="vbo-param-label">
						<?php
						echo $vbo_app->createPopover(array('title' => JText::_('VBO_GEO_MARKERS_ONEMULTI'), 'content' => JText::_('VBO_GEO_MARKERS_ONEMULTI_HELP'), 'icon_class' => VikBookingIcons::i('map-marker-alt')));
						echo ' ' . JText::_('VBO_GEO_MARKERS_ONEMULTI');
						?>
					</div>
					<div class="vbo-param-setting">
						<?php
						...
						<select id="geo_markers_multi">
							<option value="0"<?php echo $geo_markers_multi == 0 ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBO_GEO_MARKERS_ONE'); ?></option>
							<option value="1"<?php echo $geo_markers_multi == 1 ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBO_GEO_MARKERS_MULTI'); ?></option>
						</select>
					</div>
				</div>
				<div class="vbo-param-container vbo-geoinfo-param" style="display: none;">
				...
				<div class="vbo-param-container vbo-geoinfo-param" style="display: none;">
					<div class="vbo-param-label">
						<?php
						echo $vbo_app->createPopover(array('title' => JText::_('VBO_GEO_MAP_GOVERLAY'), 'content' => JText::_('VBO_GEO_MAP_GOVERLAY_HELP'), 'icon_class' => VikBookingIcons::i('images')));
						echo ' ' . JText::_('VBO_GEO_MAP_GOVERLAY');
						?>
					</div>
					<div class="vbo-param-setting">
						<?php
						$goverlay_enabled = (int)$geo->getRoomGeoParams($rooms_params, 'goverlay', 0);
						echo $vbo_app->printYesNoButtons('geo_goverlay', JText::_('VBYES'), JText::_('VBNO'), $goverlay_enabled, 1, 0, 'vboToggleGeoGroundOverlay();');
						?>
						<button type="button" id="vbo-goverlay-edit" class="btn vbo-config-btn" style="<?php echo !$goverlay_enabled ? 'display: none;' : ''; ?>" onclick="vboToggleGeoGroundOverlay();"><?php VikBookingIcons::e('images'); ?> <?php echo JText::_('VBMAINPAYMENTSEDIT'); ?></button>
					</div>
				</div>
				<?php
			}
