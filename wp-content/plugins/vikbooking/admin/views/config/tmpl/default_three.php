		...
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGFIRSTWDAY'); ?></div>
					<div class="vbo-param-setting"><select name="firstwday"><option value="0"<?php echo $firstwday == '0' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBSUNDAY'); ?></option><option value="1"<?php echo $firstwday == '1' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBMONDAY'); ?></option><option value="2"<?php echo $firstwday == '2' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBTUESDAY'); ?></option><option value="3"<?php echo $firstwday == '3' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBWEDNESDAY'); ?></option><option value="4"<?php echo $firstwday == '4' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBTHURSDAY'); ?></option><option value="5"<?php echo $firstwday == '5' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBFRIDAY'); ?></option><option value="6"<?php echo $firstwday == '6' ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBSATURDAY'); ?></option></select></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREETEN'); ?></div>
					<div class="vbo-param-setting"><input type="number" name="numcalendars" value="<?php echo VikBooking::numCalendars(); ?>" min="0" max="24"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFIGTHUMBSIZE'); ?></div>
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREENINE'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('showpartlyreserved', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::showPartlyReserved() ? 'yes' : 0), 'yes', 0); ?></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREECHECKINOUTSTAT'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('showcheckinoutonly', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::showStatusCheckinoutOnly() ? 1 : 0), 1, 0); ?></div>
				</div>

				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFIGEMAILTEMPLATE'); ?></div>
					<div class="vbo-param-setting">
						<div class="btn-wrapper input-append">
							<button type="button" class="btn vbo-edit-tmpl" data-tmpl-path="<?php echo urlencode(VBO_SITE_PATH.DS.'helpers'.DS.'email_tmpl.php'); ?>"><i class="icon-edit"></i> <?php echo JText::_('VBOCONFIGEDITTMPLFILE'); ?></button>
							<button type="button" class="btn vbo-inspector-btn" title="<?php echo addslashes(JText::_('VBO_INSPECTOR_START')); ?>" data-inspectfile="email_tmpl.php"><?php VikBookingIcons::e('paint-brush'); ?></button>
							<button type="button" class="btn vbo-edit-tmpl vbo-preview-btn" title="<?php echo addslashes(JText::_('VBOPREVIEW')); ?>" data-prew-type="email_tmpl.php" data-prew-path="<?php echo urlencode(VBO_SITE_PATH.DS.'helpers'.DS.'email_tmpl.php'); ?>"><?php VikBookingIcons::e('eye'); ?></button>
						</div>
					</div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFIGINVOICETEMPLATE'); ?></div>
					<div class="vbo-param-setting">
						<div class="btn-wrapper input-append">
							<button type="button" class="btn vbo-edit-tmpl" data-tmpl-path="<?php echo urlencode(VBO_SITE_PATH.DS.'helpers'.DS.'invoices'.DS.'invoice_tmpl.php'); ?>"><i class="icon-edit"></i> <?php echo JText::_('VBOCONFIGEDITTMPLFILE'); ?></button>
							<button type="button" class="btn vbo-inspector-btn" title="<?php echo addslashes(JText::_('VBO_INSPECTOR_START')); ?>" data-inspectfile="invoice_tmpl.php"><?php VikBookingIcons::e('paint-brush'); ?></button>
						</div>
					</div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBOMANUALINVOICE'); ?></div>
					<div class="vbo-param-setting"><button type="button" class="btn vbo-edit-tmpl" data-tmpl-path="<?php echo urlencode(VBO_SITE_PATH.DS.'helpers'.DS.'invoices'.DS.'custom_invoice_tmpl.php'); ?>"><i class="icon-edit"></i> <?php echo JText::_('VBOCONFIGEDITTMPLFILE'); ?></button></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFIGCHECKINTEMPLATE'); ?></div>
					<div class="vbo-param-setting">
						<div class="btn-wrapper input-append">
							<button type="button" class="btn vbo-edit-tmpl" data-tmpl-path="<?php echo urlencode(VBO_SITE_PATH.DS.'helpers'.DS.'checkins'.DS.'checkin_tmpl.php'); ?>"><i class="icon-edit"></i> <?php echo JText::_('VBOCONFIGEDITTMPLFILE'); ?></button>
							<button type="button" class="btn vbo-inspector-btn" title="<?php echo addslashes(JText::_('VBO_INSPECTOR_START')); ?>" data-inspectfile="checkin_tmpl.php"><?php VikBookingIcons::e('paint-brush'); ?></button>
						</div>
					</div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFIGCUSTCSSTPL'); ?></div>
					<div class="vbo-param-setting">
					<?php
					if (VBOPlatformDetection::isWordPress()) {
						 ...
						 */
						?>
						<button type="button" class="btn vbo-edit-tmpl" data-tmpl-path="<?php echo urlencode(VBO_SITE_PATH.DS.'resources'.DS.'vikbooking_custom.css'); ?>"><i class="icon-edit"></i> <?php echo JText::_('VBOCONFIGEDITTMPLFILE'); ?></button>
						<?php
					} else {
						?>
						<button type="button" class="btn vbo-edit-tmpl" data-tmpl-path="<?php echo urlencode(VBO_SITE_PATH.DS.'vikbooking_custom.css'); ?>"><i class="icon-edit"></i> <?php echo JText::_('VBOCONFIGEDITTMPLFILE'); ?></button>
						<?php
					}
					?>
					</div>
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFIGCUSTBACKCSSTPL'); ?></div>
					<div class="vbo-param-setting"><button type="button" class="btn vbo-edit-tmpl" data-tmpl-path="<?php echo urlencode(VBO_ADMIN_PATH.DS.'resources'.DS.'vikbooking_backendcustom.css'); ?>"><i class="icon-edit"></i> <?php echo JText::_('VBOCONFIGEDITTMPLFILE'); ?></button></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREESIX'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('showfooter', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::showFooter() ? 'yes' : 0), 'yes', 0); ?></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHEME'); ?></div>
					<div class="vbo-param-setting"><?php echo $themesel; ?></div>
				</div>
				<div class="vbo-param-container vbo-param-container-full">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREESEVEN'); ?></div>
					<div class="vbo-param-setting">
						<?php
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREEEIGHT'); ?></div>
	...
	<fieldset class="adminform">
		<div class="vbo-params-wrap">
			<legend class="adminlegend">
				<?php
				echo $vbo_app->createPopover(array('title' => JText::_('VBO_PREF_COLORS'), 'content' => JText::_('VBO_PREF_COLORS_HELP')));
				echo ' ' . JText::_('VBO_PREF_COLORS');
				?>
			</legend>
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBO_PREF_COLOR_TEXTS'); ?></div>
					<div class="vbo-param-setting">
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBO_PREF_COLOR_BKGROUND'); ?></div>
					<div class="vbo-param-setting">
						<div class="vbo-param-setting-top">
							...
							<span class="vbo-colorpicker-label"><?php echo JText::_('VBO_BKGROUND_COL'); ?></span>
						...
						<div class="vbo-param-setting-bottom">
							...
							<span class="vbo-colorpicker-label"><?php echo JText::_('VBO_FONT_COL'); ?></span>
							<input type="hidden" name="pref_fontcolor" id="vbo-pref-fontcolor" value="<?php echo $preferred_colors['fontcolor']; ?>" />
						</div>
					</div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBO_PREF_COLOR_BKGROUNDHOV'); ?></div>
					<div class="vbo-param-setting">
						<div class="vbo-param-setting-top">
							<span class="vbo-inspector-colorpicker-wrap">
				...
				<div id="vbo-pref-color-examples" class="vbo-param-container" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_PREF_COLOR_EXAMPLERES'); ?></div>
					<div class="vbo-param-setting">
						<div class="vbo-pref-color-example">
							<h4><?php echo JText::_('VBO_PREF_COLOR_TEXTS'); ?></h4>
						</div>
						<div class="vbo-pref-color-example">
							<button type="button" class="btn btn-small"><?php echo JText::_('VBO_PREF_COLOR_BKGROUND'); ?></button>
						</div>
					</div>
				</div>
			</div>
	...
	<fieldset class="adminform">
		<div class="vbo-params-wrap">
			...
			foreach ($colortags as $ctagk => $ctagv) {
				?>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_($ctagv['name']); ?></div>
					<div class="vbo-param-setting">
			...
			?>
				<div class="vbo-param-container" id="vbo-colortag-lasttr">
					<div class="vbo-param-label"><button class="btn vbo-colortag-add" type="button"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBOCOLORTAGADD'); ?></button></div>
					<div class="vbo-param-setting"> </div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><a class="btn btn-danger" href="index.php?option=com_vikbooking&amp;task=config&amp;reset_tags=1" onclick="return confirm('<?php echo addslashes(JText::_('VBDELCONFIRM')); ?>');"><i class="icon-remove"></i> <?php echo JText::_('VBOCOLORTAGRMALL'); ?></a></div>
					<div class="vbo-param-setting"> </div>
				</div>
			</div>
		</a>
...
jQuery(function() {
	...
	jQuery(".vbo-colortag-add").click(function() {
		jQuery("#vbo-colortag-lasttr").before(
			"<div class=\"vbo-param-container\">"+
			"<div class=\"vbo-param-label\"> <input type=\"text\" name=\"bctagname[]\" class=\"bctagname\" value=\"\" placeholder=\"<?php echo addslashes(JText::_('VBOCOLORTAGADDPLCHLD')); ?>\" size=\"25\" /> </div>"+
			"<div class=\"vbo-param-setting\">"+
