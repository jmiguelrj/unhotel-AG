...
<div class="vbo-config-maintab-left">
		...
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREECURNAME'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="currencyname" value="<?php echo JHtml::_('esc_attr', VikBooking::getCurrencyName()); ?>" size="10"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREECURSYMB'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="currencysymb" value="<?php echo JHtml::_('esc_attr', VikBooking::getCurrencySymb()); ?>" size="10"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREECURCODEPP'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="currencycodepp" value="<?php echo JHtml::_('esc_attr', VikBooking::getCurrencyCodePp()); ?>" size="10"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGNUMDECIMALS'); ?></div>
				...
				<div class="vbo-param-container vbo-param-nested">
					<div class="vbo-param-label"><?php echo JText::_('VBO_NO_EMPTY_DECIMALS'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('noemptydecimals', JText::_('VBYES'), JText::_('VBNO'), VikBooking::hideEmptyDecimals(), 1, 0); ?></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGNUMDECSEPARATOR'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="decseparator" value="<?php echo JHtml::_('esc_attr', $formatparts[1]); ?>" size="2"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGNUMTHOSEPARATOR'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="thoseparator" value="<?php echo JHtml::_('esc_attr', $formatparts[2]); ?>" size="2"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBO_POSITION'); ?></div>
					...
					echo $vbo_app->multiStateToggleSwitchField(
						...
						[
							[
								...
								'title' => JText::_('VBO_CURRENCY_POS_BEFORE'),
							],
							[
								'value' => '100 ' . VikBooking::getCurrencySymb(),
								'title' => JText::_('VBO_CURRENCY_POS_AFTER'),
							],
						],
						[
							[
	...
	<fieldset class="adminform">
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTWOFIVE'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('ivainclusa', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::ivaInclusa(true) ? 'yes' : 0), 'yes', 0); ?></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTAXSUMMARY'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('taxsummary', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::showTaxOnSummaryOnly(true) ? 'yes' : 0), 'yes', 0); ?></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGMULTIPAY'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('multipay', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::multiplePayments() ? 'yes' : 0), 'yes', 0); ?></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTWOSIX'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="paymentname" value="<?php echo JHtml::_('esc_attr', VikBooking::getPaymentName()); ?>" size="25"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGONETENSEVEN'); ?></div>
					<div class="vbo-param-setting"><input type="number" name="minuteslock" value="<?php echo VikBooking::getMinutesLock(); ?>" min="0"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGMINAUTOREMOVE'); ?></div>
...
<div class="vbo-config-maintab-right">
	<fieldset class="adminform">
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTWOTHREE'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('paytotal', JText::_('VBYES'), JText::_('VBNO'), ($pay_total ? 'yes' : 0), 'yes', 0, 'vboTogglePayDeposit();'); ?></div>
				</div>
				<div class="vbo-param-container" data-related="paytotal" style="<?php echo $pay_total ? 'display: none;' : ''; ?>">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTWOFOUR'); ?></div>
				...
				<div class="vbo-param-container" data-related="paytotal" style="<?php echo $pay_total ? 'display: none;' : ''; ?>">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFDEPOSITOVRDS'); ?></div>
					<div class="vbo-param-setting">
				...
				<div class="vbo-param-container" data-related="paytotal" style="<?php echo $pay_total ? 'display: none;' : ''; ?>">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFDEPONLYIFDADV'); ?></div>
				...
				<div class="vbo-param-container" data-related="paytotal" style="<?php echo $pay_total ? 'display: none;' : ''; ?>">
					<div class="vbo-param-label"><?php echo JText::_('VBO_CONF_DEP_BALANCE_NDAYS'); ?></div>
				...
				<div class="vbo-param-container" data-related="paytotal" style="<?php echo $pay_total ? 'display: none;' : ''; ?>">
					<div class="vbo-param-label"><?php echo JText::_('VBOCONFDEPCUSTCHOICE'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('depcustchoice', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::depositCustomerChoice() ? 'yes' : 0), 'yes', 0); ?></div>
				</div>
				<div class="vbo-param-container" data-related="paytotal" style="<?php echo $pay_total ? 'display: none;' : ''; ?>">
					<div class="vbo-param-label"><?php echo $vbo_app->createPopover(array('title' => JText::_('VBOCONFNODEPNONREFUND'), 'content' => JText::_('VBOCONFNODEPNONREFUNDHELP'))); ?> <?php echo JText::_('VBOCONFNODEPNONREFUND'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('nodepnonrefund', JText::_('VBYES'), JText::_('VBNO'), (int)VikBooking::noDepositForNonRefund(), 1, 0); ?></div>
				</div>
			</div>
		</div>
	</fieldset>
...
function vboPopulateDepositOverrides() {
	...
	try {
		...
		cur_ovr_cont += '<h3><?php echo addslashes(JText::_('VBOCONFDEPOSITOVRDS')); ?></h3>';
