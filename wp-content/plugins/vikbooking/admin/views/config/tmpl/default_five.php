		...
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSCLASS'); ?></div>
					<div class="vbo-param-setting"><?php echo $psel; ?></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSAUTOSEND'); ?></div>
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('smsautosend', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::autoSendSMSEnabled() ? 1 : 0), 1, 0); ?></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSSENDTO'); ?></div>
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSSENDWHEN'); ?></div>
					<div class="vbo-param-setting">
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSSADMINPHONE'); ?></div>
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSADMTPL'); ?></div>
					<div class="vbo-param-setting">
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSCUSTOTPL'); ?></div>
					<div class="vbo-param-setting">
						<div class="btn-toolbar vbo-smstpl-toolbar">
							<div class="btn-group pull-left vbo-smstpl-bgroup">
				...
				<div class="vbo-param-container" id="smsadmintplpend-tr" style="display: <?php echo $sendsmswhen <= 1 ? 'none' : 'flex'; ?>;">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSADMTPLPEND'); ?></div>
					<div class="vbo-param-setting">
						<div class="btn-toolbar vbo-smstpl-toolbar">
							<div class="btn-group pull-left vbo-smstpl-bgroup">
				...
				<div class="vbo-param-container" id="smscustomertplpend-tr" style="display: <?php echo $sendsmswhen <= 1 ? 'none' : 'flex'; ?>;">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSCUSTOTPLPEND'); ?></div>
					<div class="vbo-param-setting">
						<div class="btn-toolbar vbo-smstpl-toolbar">
							<div class="btn-group pull-left vbo-smstpl-bgroup">
				...
				<div class="vbo-param-container" id="smsadmintplcanc-tr">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSADMTPLCANC'); ?></div>
					<div class="vbo-param-setting">
						<div class="btn-toolbar vbo-smstpl-toolbar">
							<div class="btn-group pull-left vbo-smstpl-bgroup">
				...
				<div class="vbo-param-container" id="smscustomertplcanc-tr">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSCUSTOTPLCANC'); ?></div>
					<div class="vbo-param-setting">
						<div class="btn-toolbar vbo-smstpl-toolbar">
							<div class="btn-group pull-left vbo-smstpl-bgroup">
...
<div class="vbo-config-maintab-right">
	<fieldset class="adminform">
		<div class="vbo-params-wrap">
			<legend class="adminlegend"><?php echo JText::_('VBCONFIGSMSPARAMETERS'); ?></legend>
			<div class="vbo-params-container">
		...
		if (!empty($current_smsapi)) {
			...
			if (method_exists('VikSmsApi', 'estimate')) {
				?>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSMSREMAINBAL'); ?></div>
					<div class="vbo-param-setting">
						<button type="button" class="btn vbo-config-btn" onclick="vboEstimateCredit();"><i class="vboicn-coin-euro"></i><?php echo JText::_('VBCONFIGSMSESTCREDIT'); ?></button>
