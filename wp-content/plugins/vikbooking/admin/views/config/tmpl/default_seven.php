...
<div class="vbo-config-maintab-top">
	<fieldset class="adminform vbo-config-fieldset-large">
		<div class="vbo-params-wrap">
			<legend class="adminlegend"><?php echo JText::_('VBO_COND_TEXT_RULES'); ?></legend>
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-setting">
						<a href="index.php?option=com_vikbooking&task=newcondtext" class="btn vbo-config-btn"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBO_NEW_COND_TEXT'); ?></a>
					</div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-setting">
						<div class="table-responsive vbo-list-table-rounded">
							<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped vbo-list-table">
								<thead>
									<tr>
										<th class="title left" width="200"><?php echo JText::_( 'VBO_CONDTEXT_NAME' ); ?></th>
										<th class="title left vbo-white-break" width="200"><?php echo JText::_( 'VBO_CONDTEXT_TKN' ); ?></th>
										<th class="title center vbo-white-break" width="100"><?php echo JText::_( 'VBO_WIDGETS_LASTUPD' ); ?></th>
										<th class="title center vbo-white-break" width="300"><?php echo JText::_( 'VBO_TEMPLATE_FILES' ); ?></th>
							...
							for ($i = 0, $n = count($rows); $i < $n; $i++) {
								...
								<tr class="row<?php echo $k; ?>">
									...
									<td class="center">
										<a href="index.php?option=com_vikbooking&amp;task=removecondtext&amp;cid[]=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm(Joomla.JText._('VBDELCONFIRM'));"><?php VikBookingIcons::e('trash'); ?> <?php echo JText::_('VBMAINCRONDEL'); ?></a>
									</td>
								</tr>	
								<?php
								$k = 1 - $k;
	...
	<fieldset class="adminform vbo-config-fieldset-small">
		<div class="vbo-params-wrap">
			<legend class="adminlegend"><?php echo JText::_('VBOCONFIGEDITTMPLFILE'); ?></legend>
			<div class="vbo-params-container">
				<div class="vbo-param-container">
				...
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::_('VBO_CONT_WRAPPER'); ?></div>
					<div class="vbo-param-setting">
				...
				<div class="vbo-param-container vbo-param-nested vbo-contwrapper-edit" style="display: none;">
					...
					?>
					<div class="vbo-param-setting">
						<textarea id="vbo-contwrapper-html" style="width: 100% !important; min-height: 250px;"><?php echo JHtml::_('esc_textarea', $cont_wrapper_opening . "\n\n\t\t--- " . JText::_('VBO_TPL_TEXT') . " ---\n\n" . $cont_wrapper_closing); ?></textarea>
						<div class="vbo-param-setting-comment"><?php echo JText::_('VBO_CONT_WRAPPER_HELP'); ?></div>
					</div>
				</div>
				<div class="vbo-param-container vbo-param-nested vbo-contwrapper-edit" style="display: none;">
					<div class="vbo-param-setting">
						<button id="vbo-contwrapper-save" type="button" class="btn btn-success"><?php VikBookingIcons::e('save'); ?> <?php echo JText::_('VBSAVE'); ?></button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					<div class="vbo-param-setting">
						<div class="vbo-inspector-cmds">
							<button id="vbo-inspector-save" type="button" class="btn btn-success" disabled><?php VikBookingIcons::e('save'); ?> <?php echo JText::_('VBSAVE'); ?></button>
							<button id="vbo-inspector-preview" type="button" class="btn btn-secondary" data-prew-type="" style="display: none;"><?php VikBookingIcons::e('eye'); ?> <?php echo JText::_('VBOPREVIEW'); ?></button>
							<button id="vbo-inspector-cancel" type="button" class="btn btn-secondary"><?php VikBookingIcons::e('times'); ?> <?php echo JText::_('VBANNULLA'); ?></button>
						</div>
					</div>
				</div>
				<div class="vbo-param-container">
				...
				<div class="vbo-param-container vbo-inspector-css-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_INSP_HTML_TAG'); ?></div>
					<div class="vbo-param-setting">
						<span id="vbo-inspector-css-tag" class="vbo-inspector-css-tag"></span>
					</div>
				</div>
				<div class="vbo-param-container vbo-inspector-css-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_INSP_CSS_FONTCOLOR'); ?></div>
					<div class="vbo-param-setting">
				...
				<div class="vbo-param-container vbo-inspector-css-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_INSP_CSS_BACKGCOLOR'); ?></div>
					<div class="vbo-param-setting">
						<span class="vbo-inspector-colorpicker-wrap">
				...
				<div class="vbo-param-container vbo-inspector-css-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_INSP_CSS_BORDER'); ?></div>
					<div class="vbo-param-setting vbo-toggle-small">
						<?php echo $vbo_app->printYesNoButtons('vbo-inspector-css-border', JText::_('VBYES'), JText::_('VBNO'), 0, 1, 0, 'vboToggleCSSBorderParams();'); ?>
					</div>
				</div>
				<div class="vbo-param-container vbo-inspector-css-border-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_INSP_CSS_BORDERWIDTH'); ?> (px)</div>
					<div class="vbo-param-setting">
						<input type="number" min="0" id="vbo-inspector-css-borderwidth" value="0" />
					</div>
				</div>
				<div class="vbo-param-container vbo-inspector-css-border-param" style="display: none;">
					<div class="vbo-param-label"><?php echo JText::_('VBO_INSP_CSS_BORDERCOLOR'); ?></div>
					<div class="vbo-param-setting">
						<span class="vbo-inspector-colorpicker-wrap">
