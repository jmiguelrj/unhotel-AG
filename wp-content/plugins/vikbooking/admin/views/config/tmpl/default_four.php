	...
	<div class="vbo-params-wrap">
		...
		<div class="vbo-params-container">
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo JText::_('VBCONFIGTHREEONE'); ?></div>
				<div class="vbo-param-setting"><input type="text" name="fronttitle" value="<?php echo JHtml::_('esc_attr', VikBooking::getFrontTitle()); ?>" size="30"/></div>
			</div>
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo JText::_('VBCONFIGFOURLOGO'); ?></div>
			...
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo JText::_('VBCONFIGLOGOBACKEND'); ?></div>
			...
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo JText::_('VBCONFIGSENDEMAILWHEN'); ?></div>
				<div class="vbo-param-setting"><select name="sendemailwhen"><option value="1"><?php echo JText::_('VBCONFIGSMSSENDWHENCONFPEND'); ?></option><option value="2"<?php echo $sendemailwhen > 1 ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBCONFIGSMSSENDWHENCONF'); ?></option></select></div>
			</div>
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo $vbo_app->createPopover(array('title' => JText::_('VBCONFIGATTACHICAL'), 'content' => JText::_('VBCONFIGATTACHICALHELP'))); ?> <?php echo JText::_('VBCONFIGATTACHICAL'); ?></div>
				<div class="vbo-param-setting">
					<select name="attachical">
						<option value="1"<?php echo $attachical === 1 ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBCONFIGSMSSENDTOADMIN') . ' + ' . JText::_('VBCONFIGSMSSENDTOCUSTOMER'); ?></option>
						<option value="2"<?php echo $attachical === 2 ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBCONFIGSMSSENDTOADMIN'); ?></option>
						<option value="3"<?php echo $attachical === 3 ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBCONFIGSMSSENDTOCUSTOMER'); ?></option>
						<option value="0"<?php echo $attachical === 0 ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBNO'); ?></option>
					</select>
				</div>
			</div>
			<div class="vbo-param-container vbo-param-container-full">
				<div class="vbo-param-label"><?php echo JText::_('VBOTERMSCONDS'); ?></div>
				<div class="vbo-param-setting">
				<?php
				/**
			...
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo JText::_('VBCONFIGFOURORDMAILFOOTER'); ?></div>
			...
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo JText::_('VBCONFIGFOURFOUR'); ?></div>
