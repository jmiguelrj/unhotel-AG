				...
				<div class="vbo-params-wrap">
					...
					<div class="vbo-params-container">
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBNEWCARATONE'); ?></div>
						...
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo $vbo_app->createPopover(array('title' => JText::_('VBOCARATIMGORICON'), 'content' => JText::_('VBOCARATIMGORICONHELP'))); ?> <?php echo JText::_('VBNEWCARATTWO'); ?></div>
					...
					if (count($this->preset_icons)) {
						?>
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBOFONTICNSPREINST'); ?></div>
							<div class="vbo-param-setting">
					...
					?>
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBNEWCARATTHREE'); ?></div>
							<div class="vbo-param-setting">
			...
			<fieldset class="adminform">
				<div class="vbo-params-wrap">
					...
					<div class="vbo-params-container">
						...
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBOPOSITIONORDERING'); ?></div>
							<div class="vbo-param-setting">
								<input type="number" name="ordering" value="<?php echo count($row) ? $row['ordering'] : ''; ?>"/>
							<?php
							if (!count($row)) {
								?>
								<span class="vbo-param-setting-comment"><?php echo JText::_('VBOPOSITIONORDERINGHELP'); ?></span>
								<?php
							}
							?>
							</div>
