...
<div class="vbo-info-overlay-block vbo-info-overlay-block-animation">
	...
	<div class="vbo-info-overlay-content vbo-info-overlay-content-wizard vbo-info-overlay-content-hidden">
		<h3><?php echo JText::_('VBMENUFIVE'); ?></h3>
		<div class="vbo-overlay-wizard-wrap">
			<form method="post" action="index.php?option=com_vikbooking">
				<div class="vbo-tariffs-wizard-help-wrap">
					<p>
						<span><?php echo JText::_('VBOWIZARDRPLANSMESS'); ?></span>
					</p>
					<p>
						<?php echo JText::_('VBOWIZARDRPLANSMESS2'); ?>
					</p>
					<h4><?php echo JText::_('VBOSUGGRATEPLANS'); ?></h4>
				</div>
				<div class="vbo-rplans-wizard-wrap">
					<div class="vbo-rplans-wizard-tprice-wrap">
						<div class="vbo-rplans-wizard-tprice-name">
							<label for="rplanpub1-on"><?php echo JText::_('VBOSTANDARDRATE'); ?></label>
							<?php echo $vbo_app->printYesNoButtons('rplanpub1', JText::_('VBYES'), JText::_('VBNO'), 1, 1, 0); ?>
						</div>
						<div class="vbo-rplans-wizard-tprice-bkincl">
							<label for="rplanbk1"><?php echo JText::_('VBNEWPRICEBREAKFAST'); ?></label>
							<input type="checkbox" name="rplanbk1" id="rplanbk1" value="1" checked="checked" />
						</div>
					</div>
					<div class="vbo-rplans-wizard-tprice-wrap">
						<div class="vbo-rplans-wizard-tprice-name">
							<label for="rplanpub2-on"><?php echo JText::_('VBONONREFRATE'); ?></label>
							<?php echo $vbo_app->printYesNoButtons('rplanpub2', JText::_('VBYES'), JText::_('VBNO'), 1, 1, 0); ?>
						</div>
						<div class="vbo-rplans-wizard-tprice-bkincl">
							<label for="rplanbk2"><?php echo JText::_('VBNEWPRICEBREAKFAST'); ?></label>
							<input type="checkbox" name="rplanbk2" id="rplanbk2" value="1" />
						</div>
					</div>
				</div>
				<div class="vbo-tariffs-wizard-prices-submit">
					<button type="button" class="btn btn-danger" onclick="hideVboWizard();"><?php echo JText::_('VBOCLOSE'); ?></button>
					<button type="submit" class="btn btn-success"><?php echo JText::_('VBOCREATERATEPLANS'); ?></button>
				</div>
