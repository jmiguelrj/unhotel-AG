...
<div class="vbo-dashboard-firstsetup-container vbo-sampledata-container">
	<div class="vbo-dashboard-firstsetup-head">
		<h3><?php echo JText::_('VBO_SAMPLEDATA_INSTALL'); ?></h3>
		<h4><?php echo JText::_('VBO_SAMPLEDATA_INTRO_DESCR'); ?></h4>
		<h4><?php echo JText::_('VBO_SAMPLEDATA_INTRO_SUBDESCR'); ?></h4>
	</div>
			...
			<div class="vbo-dashboard-firstsetup-task-wrap">
				<div class="vbo-dashboard-firstsetup-task-details">
					<select id="vik-sample-data-list">
						<option value="">- <?php echo JText::_('VBODASHINSTSAMPLEDBTN'); ?></option>
					</select>
				</div>
				<div class="vbo-dashboard-firstsetup-task-action">
					<button type="button" class="btn vbo-sampledata-btn" id="vik-sample-data-install" disabled><?php echo JText::_('VBO_SAMPLEDATA_INSTALL'); ?></button>
				</div>
			</div>
		</div>
	</div>
