	...
	jQuery('#vbo-add-trkcampaign').click(function() {
		...
		var campcont = '<div class="vbo-trackings-custcampaign">' + "\n" +
							'<div class="vbo-trackings-custcampaign-box vbo-trackings-custcampaign-name">' + "\n" +
								'<label for="vbo-name-'+ind+'"><?php echo addslashes(JText::_('VBTRKCAMPAIGNNAME')); ?></label>' + "\n" +
								'<input type="text" name="trkcampname[]" id="vbo-name-'+ind+'" value="" size="30" placeholder="<?php echo addslashes(JText::_('VBTRKCAMPAIGNNAME')); ?>" />' + "\n" +
							'</div>' + "\n" +
							'<div class="vbo-trackings-custcampaign-box vbo-trackings-custcampaign-key">' + "\n" +
								'<label for="vbo-key-'+ind+'"><?php echo addslashes(JText::_('VBTRKCAMPAIGNKEY')); ?></label>' + "\n" +
							...
							'<div class="vbo-trackings-custcampaign-box vbo-trackings-custcampaign-val">' + "\n" +
								'<label for="vbo-val-'+ind+'"><?php echo addslashes(JText::_('VBTRKCAMPAIGNVAL')); ?></label>' + "\n" +
	...
	<div class="vbo-admin-container vbo-config-tab-container">
		...
		<fieldset class="adminform">
			<div class="vbo-params-wrap vbo-params-wrap-fullwidth">
				<legend class="adminlegend"><?php echo JText::_('VBTRKSETTINGS'); ?></legend>
				<div class="vbo-params-container">

					<div class="vbo-param-container">
						<div class="vbo-param-label"><?php echo JText::_('VBTRKENABLED'); ?></div>
						<div class="vbo-param-setting">
							<?php echo $vbo_app->printYesNoButtons('trkenabled', JText::_('VBYES'), JText::_('VBNO'), (int)$trksettings['trkenabled'], 1, 0); ?>
						</div>
					</div>

					<div class="vbo-param-container">
						<div class="vbo-param-label"><?php echo $vbo_app->createPopover(array('title' => JText::_('VBTRKCOOKIERFRDUR'), 'content' => JText::_('VBTRKCOOKIERFRDURHELP'))); ?> <?php echo JText::_('VBTRKCOOKIERFRDUR'); ?></div>
						<div class="vbo-param-setting">
							<input type="number" step="any" min="0" name="trkcookierfrdur" value="<?php echo JHtml::_('esc_attr', $trksettings['trkcookierfrdur']); ?>" /> (<?php echo strtolower(JText::_('VBCONFIGSEARCHPMAXDATEDAYS')); ?>)
						</div>
					</div>

					<div class="vbo-param-container">
						<div class="vbo-param-label"><?php echo $vbo_app->createPopover(array('title' => JText::_('VBTRKCAMPAIGNS'), 'content' => JText::_('VBTRKCAMPAIGNSHELP'))); ?> <?php echo JText::_('VBTRKCAMPAIGNS'); ?></div>
						<div class="vbo-param-setting">
							<button class="btn vbo-config-btn" type="button" id="vbo-add-trkcampaign"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBTRKADDCAMPAIGN'); ?></button>
						</div>
					</div>
						...
						<div class="vbo-param-setting">
							...
							foreach ($trksettings['trkcampaigns'] as $rkey => $rvalue) {
								...
								<div class="vbo-trackings-custcampaign">
									<div class="vbo-trackings-custcampaign-box vbo-trackings-custcampaign-name">
										<label for="vbo-name-<?php echo $i; ?>"><?php echo JText::_('VBTRKCAMPAIGNNAME'); ?></label>
										<input type="text" name="trkcampname[]" id="vbo-name-<?php echo $i; ?>" value="<?php echo JHtml::_('esc_attr', $rvalue['name']); ?>" size="30" />
									</div>
									<div class="vbo-trackings-custcampaign-box vbo-trackings-custcampaign-key">
										<label for="vbo-key-<?php echo $i; ?>"><?php echo JText::_('VBTRKCAMPAIGNKEY'); ?></label>
										<input type="text" name="trkcampkey[]" id="vbo-key-<?php echo $i; ?>" onkeyup="vboCustCampaignUri(this);" value="<?php echo JHtml::_('esc_attr', $rkey); ?>" size="10" />
									</div>
									<div class="vbo-trackings-custcampaign-box vbo-trackings-custcampaign-val">
										<label for="vbo-val-<?php echo $i; ?>"><?php echo JText::_('VBTRKCAMPAIGNVAL'); ?></label>
										<input type="text" name="trkcampval[]" id="vbo-val-<?php echo $i; ?>" onkeyup="vboCustCampaignUri(this);" value="<?php echo JHtml::_('esc_attr', $rvalue['value']); ?>" size="10" />
									</div>
									<div class="vbo-trackings-custcampaign-box vbo-trackings-custcampaign-rm">
										<a class="btn btn-danger" href="javascript: void(0);" onclick="vboRmCustCampaign(this);">&times;</a>
									</div>
					...
					<div class="vbo-param-container vbo-param-container-full">
						<div class="vbo-param-setting">
							<span class="vbo-param-setting-comment"><?php VikBookingIcons::e('info-circle'); ?> <?php echo JText::_('VBTRKCOOKIEEXPL'); ?></span>
						</div>
					</div>
