...
<div class="vbo-info-overlay-block vbo-info-overlay-block-animation">
	...
	<div class="vbo-info-overlay-content vbo-info-overlay-content-wizard vbo-info-overlay-content-hidden">
		<h3><?php echo "{$name} - " . JText::_('VBINSERTFEE'); ?></h3>
		<div class="vbo-overlay-wizard-wrap">
			<form method="post" action="index.php?option=com_vikbooking">
				<div class="vbo-tariffs-wizard-help-wrap">
					<p>
						<span><?php echo JText::_('VBOWIZARDTARIFFSMESS'); ?></span>
						<?php echo $vbo_app->createPopover(array('title' => JText::_('VBINSERTFEE'), 'content' => JText::_('VBOWIZARDTARIFFSHELP'), 'placement' => 'bottom')); ?>
					</p>
					<h4><?php echo JText::_('VBOWIZARDTARIFFSWHTC'); ?></h4>
				</div>
				...
				<div class="vbo-tariffs-wizard-prices-submit">
					<input type="submit" class="btn btn-success" name="newdispcost" value="<?php echo JText::_('VBINSERTFEE'); ?>"/>
				</div>
