...
<form action="index.php?option=com_vikbooking" method="post" name="adminForm" id="adminForm">
	...
	<div id="filter-bar" class="btn-toolbar vbo-btn-toolbar vbo-trackings-filters" style="width: 100%; display: inline-block;">
		<div class="btn-group pull-right">
			<a class="btn" href="index.php?option=com_vikbooking&task=trkconfig"><?php VikBookingIcons::e('cogs'); ?> <?php echo JText::_('VBTRKSETTINGS'); ?></a>
		</div>
		<div class="btn-group pull-left input-append">
			<input type="text" id="vbo-date-from" placeholder="<?php echo JText::_('VBNEWSEASONONE'); ?>" value="<?php echo $pdatefiltfrom; ?>" size="14" name="datefiltfrom" onfocus="this.blur();" />
			<button type="button" class="btn" id="vbo-date-from-trig"><i class="icon-calendar"></i></button>
		</div>
		<div class="btn-group pull-left input-append">
			<input type="text" id="vbo-date-to" placeholder="<?php echo JText::_('VBNEWSEASONTWO'); ?>" value="<?php echo $pdatefiltto; ?>" size="14" name="datefiltto" onfocus="this.blur();" />
			<button type="button" class="btn" id="vbo-date-to-trig"><i class="icon-calendar"></i></button>
		</div>
		<div class="btn-group pull-left">
		<?php
		$datesel = '<select name="datefilt">';
		$datesel .= '<option value="1"'.(!empty($pdatefilt) && $pdatefilt == 1 ? ' selected="selected"' : '').'>'.JText::_('VBTRKFILTTRKDATES').'</option>';
		$datesel .= '<option value="2"'.(!empty($pdatefilt) && $pdatefilt == 2 ? ' selected="selected"' : '').'>'.JText::_('VBTRKBOOKINGDATES').'</option>';
		$datesel .= '<option value="3"'.(!empty($pdatefilt) && $pdatefilt == 3 ? ' selected="selected"' : '').'>'.JText::_('VBOFILTERDATEIN').'</option>';
		$datesel .= '<option value="4"'.(!empty($pdatefilt) && $pdatefilt == 4 ? ' selected="selected"' : '').'>'.JText::_('VBOFILTERDATEOUT').'</option>';
		$datesel .= '</select>';
		echo $datesel;
		?>
		</div>
		...
		<div class="btn-group pull-left">
			<select name="countryfilt" id="countryfilt">
				<option value=""><?php echo JText::_('VBCOUNTRYFILTER'); ?></option>
			<?php
		...
		<div class="btn-group pull-left">
			<select name="referrer" style="max-width: 170px;">
				<option value=""><?php echo JText::_('VBREFERRERFILTER'); ?></option>
			<?php
		...
		<div class="btn-group pull-left">
			<button type="submit" class="btn"><i class="icon-search"></i> <?php echo JText::_('VBTRKFILTRES'); ?></button>
		</div>
		<div class="btn-group pull-left">
...
if (!(int)VikBookingTracker::loadSettings('trkenabled')) {
	?>
	<p class="err"><?php echo JText::_('VBTRKDISABLED'); ?></p>
	<?php
}
if (empty($rows)) {
	?>
	<p class="warn"><?php echo JText::_('VBNOTRACKINGS'); ?></p>
	<?php
} else {
	...
	<div class="vbo-trackings-outer-response">
		<div class="vbo-trackings-tabs">
			<div class="vbo-trackings-tab vbo-trackings-tab-active" data-vbotab="vbo-trackings-tabcont-list"><?php echo JText::_('VBTRKVISITORS'); ?></div>
			<div class="vbo-trackings-tab" data-vbotab="vbo-trackings-tabcont-stats"><?php echo JText::_('VBTRKCONVRATES'); ?></div>
		</div>
		<div class="vbo-trackings-tabcont-list" style="display: block;">
					...
					<div class="vbo-trackings-table-head-inner">
						...
						<div class="vbo-trackings-table-head-cell vbo-trackings-table-cell-lastdt">
							<a href="index.php?option=com_vikbooking&amp;task=trackings<?php echo $dates_filter; ?>&amp;vborderby=lastdt&amp;vbordersort=<?php echo ($orderby == "lastdt" && $ordersort == "ASC" ? "DESC" : "ASC"); ?>" class="<?php echo ($orderby == "lastdt" && $ordersort == "ASC" ? "vbo-list-activesort" : ($orderby == "lastdt" ? "vbo-list-activesort" : "")); ?>">
								<?php echo JText::_('VBTRKLASTDT').($orderby == "lastdt" && $ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($orderby == "lastdt" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
							</a>
						</div>
						<div class="vbo-trackings-table-head-cell vbo-trackings-table-cell-customer">
							<span><?php echo JText::_( 'VBOCUSTOMER' ); ?></span>
						</div>
						<div class="vbo-trackings-table-head-cell vbo-trackings-table-cell-country">
							<a href="index.php?option=com_vikbooking&amp;task=trackings<?php echo $dates_filter; ?>&amp;vborderby=country&amp;vbordersort=<?php echo ($orderby == "country" && $ordersort == "ASC" ? "DESC" : "ASC"); ?>" class="<?php echo ($orderby == "country" && $ordersort == "ASC" ? "vbo-list-activesort" : ($orderby == "country" ? "vbo-list-activesort" : "")); ?>">
								<?php echo JText::_('ORDER_STATE').($orderby == "country" && $ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($orderby == "country" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
							</a>
						</div>
						<div class="vbo-trackings-table-head-cell vbo-trackings-table-cell-geo">
							<a href="index.php?option=com_vikbooking&amp;task=trackings<?php echo $dates_filter; ?>&amp;vborderby=geo&amp;vbordersort=<?php echo ($orderby == "geo" && $ordersort == "ASC" ? "DESC" : "ASC"); ?>" class="<?php echo ($orderby == "geo" && $ordersort == "ASC" ? "vbo-list-activesort" : ($orderby == "geo" ? "vbo-list-activesort" : "")); ?>">
								<?php echo JText::_('VBTRKGEOINFO').($orderby == "geo" && $ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($orderby == "geo" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
							</a>
						</div>
						<div class="vbo-trackings-table-head-cell vbo-trackings-table-cell-dt">
							<a href="index.php?option=com_vikbooking&amp;task=trackings<?php echo $dates_filter; ?>&amp;vborderby=dt&amp;vbordersort=<?php echo ($orderby == "dt" && $ordersort == "ASC" ? "DESC" : "ASC"); ?>" class="<?php echo ($orderby == "dt" && $ordersort == "ASC" ? "vbo-list-activesort" : ($orderby == "dt" ? "vbo-list-activesort" : "")); ?>">
								<?php echo JText::_('VBTRKFIRSTDT').($orderby == "dt" && $ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($orderby == "dt" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
							</a>
						</div>
						<div class="vbo-trackings-table-head-cell center vbo-trackings-table-cell-published">
							<a href="index.php?option=com_vikbooking&amp;task=trackings<?php echo $dates_filter; ?>&amp;vborderby=published&amp;vbordersort=<?php echo ($orderby == "published" && $ordersort == "ASC" ? "DESC" : "ASC"); ?>" class="<?php echo ($orderby == "published" && $ordersort == "ASC" ? "vbo-list-activesort" : ($orderby == "published" ? "vbo-list-activesort" : "")); ?>">
								<?php echo JText::_('VBTRKPUBLISHED').($orderby == "published" && $ordersort == "ASC" ? '<i class="'.VikBookingIcons::i('sort-asc').'"></i>' : ($orderby == "published" ? '<i class="'.VikBookingIcons::i('sort-desc').'"></i>' : '<i class="'.VikBookingIcons::i('sort').'"></i>')); ?>
							</a>
						</div>
					</div>
				</div>
			...
			for ($i = 0, $n = count($rows); $i < $n; $i++) {
				$row = $rows[$i];
				$customer_info = JText::_('VBOANONYMOUS');
				...
				?>
					<div class="vbo-trackings-table-body-row">
						...
						<div class="vbo-trackings-table-body-cell vbo-trackings-table-cell-lastdt">
							<div class="vbo-trackings-table-body-hidden-lbl"><?php echo JText::_('VBTRKLASTDT'); ?></div>
							<div class="vbo-trackings-dtonly">
								<?php echo date(str_replace("/", $datesep, $df), strtotime($row['lastdt'])); ?>
							</div>
							<div class="vbo-trackings-timeonly">
								<span class="vbo-trackings-wday"><?php echo JText::_('VB'.strtoupper(substr($lastdt_info['weekday'], 0, 3))); ?></span>
						...
						<div class="vbo-trackings-table-body-cell vbo-trackings-table-cell-customer">
							<div class="vbo-trackings-table-body-hidden-lbl"><?php echo JText::_('VBOCUSTOMER'); ?></div>
						...
						<div class="vbo-trackings-table-body-cell vbo-trackings-table-cell-country" id="country-<?php echo $row['id']; ?>">
							<div class="vbo-trackings-table-body-hidden-lbl"><?php echo JText::_('ORDER_STATE'); ?></div>
						...
						<div class="vbo-trackings-table-body-cell vbo-trackings-table-cell-geo" id="geo-<?php echo $row['id']; ?>">
							<div class="vbo-trackings-table-body-hidden-lbl"><?php echo JText::_('VBTRKGEOINFO'); ?></div>
							<?php echo !empty($row['geo']) ? $row['geo'] : '-----'; ?>
						</div>
						<div class="vbo-trackings-table-body-cell vbo-trackings-table-cell-dt">
							<div class="vbo-trackings-table-body-hidden-lbl"><?php echo JText::_('VBTRKFIRSTDT'); ?></div>
							<div class="vbo-trackings-dtonly">
								<?php echo date(str_replace("/", $datesep, $df), strtotime($row['dt'])); ?>
							</div>
							<div class="vbo-trackings-timeonly">
								<span class="vbo-trackings-wday"><?php echo JText::_('VB'.strtoupper(substr($dt_info['weekday'], 0, 3))); ?></span>
						...
						<div class="vbo-trackings-table-body-cell center vbo-trackings-table-cell-published">
							<div class="vbo-trackings-table-body-hidden-lbl"><?php echo JText::_('VBTRKPUBLISHED'); ?></div>
							<a href="index.php?option=com_vikbooking&amp;task=modtracking&amp;cid[]=<?php echo $row['id']; ?>"><?php echo ($row['published'] ? "<i class=\"".VikBookingIcons::i('check', 'vbo-icn-img')."\" style=\"color: #099909;\" title=\"".JText::_('VBTRKMAKENOTAVAIL')."\"></i>" : "<i class=\"".VikBookingIcons::i('times-circle', 'vbo-icn-img')."\" style=\"color: #ff0000;\" title=\"".JText::_('VBTRKMAKEAVAIL')."\"></i>"); ?></a>
						</div>
							...
							foreach ($row['infos'] as $k => $info) {
								...
								if (!empty($device)) {
									...
									<div class="vbo-tracking-info-device-cont">
										<div class="vbo-tracking-info-subrow-lbl"><?php echo JText::_('VBTRKDEVICE'); ?></div>
								...
								?>
									<div class="vbo-tracking-info-dt-cont">
										<div class="vbo-tracking-info-subrow-lbl"><?php echo JText::_('VBTRKTRACKTIME'); ?></div>
									<?php
									if (!$is_subidentifier) {
										...
										<div class="vbo-tracking-info-timeonly">
											<span class="vbo-tracking-info-wday"><?php echo JText::_('VB'.strtoupper(substr($subdt_info['weekday'], 0, 3))); ?></span>
										...
										$diff_type = JText::_('VBTRKDIFFSECS');
										if ($diff_info['type'] == 'minutes') {
											$diff_type = JText::_('VBTRKDIFFMINS');
										} elseif ($diff_info['type'] == 'hours') {
											$diff_type = JText::_('VBCONFIGONETENEIGHT');
										}
										?>
									...
									<div class="vbo-tracking-info-dates-cont">
										<div class="vbo-tracking-info-subrow-lbl"><?php echo JText::_('VBTRKBOOKINGDATES'); ?></div>
										<div class="vbo-tracking-info-dates-in">
											<span class="vbo-tracking-info-lbl">
												<?php echo JText::_('VBPICKUPAT'); ?>
											</span>
											<span class="vbo-tracking-info-val">
												<?php
												$tsdt = strtotime($trkdata->checkin);
												$time_info = getdate($tsdt);
												echo JText::_('VB'.strtoupper(substr($time_info['weekday'], 0, 3))) . ', ' . date(str_replace("/", $datesep, $df), $tsdt);
												?>
											</span>
										</div>
										<div class="vbo-tracking-info-dates-out">
											<span class="vbo-tracking-info-lbl">
												<?php echo JText::_('VBRELEASEAT'); ?>
											</span>
											<span class="vbo-tracking-info-val">
												<?php
									...
									if (isset($trkdata->nights)) {
										...
										<div class="vbo-tracking-info-dates-out">
											<span class="vbo-tracking-info-lbl">
												<?php echo JText::_('VBPVIEWORDERSSIX'); ?>
											</span>
											<span class="vbo-tracking-info-val">
								...
								if (isset($trkdata->party)) {
									...
									<div class="vbo-tracking-info-party-cont">
										<div class="vbo-tracking-info-subrow-lbl"><?php echo JText::_('VBQUICKRESGUESTS'); ?></div>
									<?php
									foreach ($trkdata->party as $numroom => $guests) {
										?>
										<div class="vbo-tracking-info-party-room">
											<span class="vbo-tracking-info-lbl">
												<?php echo JText::_('VBMAILROOMNUM').$numroom; ?>
											</span>
											<span class="vbo-tracking-info-val">
												<?php echo $guests->adults." ".($guests->adults > 1 ? JText::_('VBMAILADULTS') : JText::_('VBMAILADULT')).($guests->children > 0 ? ", ".$guests->children." ".($guests->children > 1 ? JText::_('VBMAILCHILDREN') : JText::_('VBMAILCHILD')) : ""); ?>
											</span>
										</div>
										<?php
									}
								...
								if (isset($trkdata->rooms) || isset($trkdata->rplans)) {
									...
									<div class="vbo-tracking-info-roomsrates-cont">
										<div class="vbo-tracking-info-subrow-lbl"><?php echo JText::_('VBTRKROOMSRATES'); ?></div>
									<?php
										...
										if (isset($trkdata->rindex) && is_array($trkdata->rindex)) {
											...
											if (count($rindexes)) {
												...
												<div class="vbo-tracking-info-rooms-room">
													<span class="vbo-tracking-info-lbl">
														<?php echo JText::_('VBODISTFEATURERUNIT') . ' ' . implode(', ', $trkdata->rindex); ?>
													</span>
												</div>
												<?php
											}
								...
								if (!empty($info['idorder'])) {
									if ($info['status'] == "confirmed") {
										...
										$saystaus = '<span class="label label-error vbo-status-label">'.JText::_('VBCANCELLED').'</span>';
									}
									?>
									<div class="vbo-tracking-info-booking-cont">
										<div class="vbo-tracking-info-subrow-lbl"><?php echo JText::_('VBTRKBOOKCONV'); ?></div>
										<?php echo $saystaus; ?>
									...
									if (count($extra_trk_props)) {
										...
										?>
									<div class="vbo-tracking-info-booking-cont">
										<div class="vbo-tracking-info-subrow-lbl"><?php echo JText::_('VBOGUESTEXTRANOTES'); ?></div>
								...
								if (!empty($info['referrer'])) {
									...
									<div class="vbo-tracking-info-booking-referrer">
										<div class="vbo-tracking-info-subrow-lbl"><?php echo JText::_('VBTRKREFERRER'); ?></div>
		...
		<div class="vbo-trackings-tabcont-stats" style="display: none;">
			<div class="vbo-trackings-chart-bestnights">
				<h4><?php echo JText::_('VBTRKMOSTDEMNIGHTS'); ?></h4>
			<?php
			...
			foreach ($demands_nights as $dt => $tot) {
				...
				<div class="vbo-trackings-chart-container" id="vbo-trackings-chart-container-<?php echo $dt; ?>">
					<span class="vbo-trackings-chart-date"><?php echo JText::_('VB'.strtoupper(substr($dt_info['weekday'], 0, 3))); ?>, <?php echo date(str_replace("/", $datesep, $df), $dt_info[0]); ?></span>
					<div class="vbo-trackings-chart-cont">
						<div class="vbo-trackings-chart-totreqs">
							...
							<span class="vbo-trackings-chart-txt"><?php echo JText::_('VBTRKREQSNUM'); ?></span>
						</div>
						<div class="vbo-trackings-chart-totviss">
							<span class="vbo-trackings-chart-tot"><?php echo count($demands_count[$dt]); ?></span>
							<span class="vbo-trackings-chart-txt"><?php echo JText::_('VBTRKVISSNUM'); ?></span>
						</div>
					</div>
				</div>
				<?php
				...
				<div class="vbo-trackings-chart-avgvals">
					<div class="vbo-trackings-chart-avgval-container">
						...
						<div class="vbo-trackings-chart-avgval-listcont">
							...
							<div class="vbo-trackings-avgval">
								<div class="vbo-trackings-avgval-det">
									<h5><?php echo JText::_('VBCUSTOMERTOTBOOKINGS'); ?></h5>
							...
							<div class="vbo-trackings-avgval">
								<div class="vbo-trackings-avgval-det">
									<h5><?php echo JText::_('VBTRKAVGLOS'); ?></h5>
							...
							<div class="vbo-trackings-avgval">
								<div class="vbo-trackings-avgval-det">
									<h5><?php echo JText::_('VBTRKAVGCONVRATE'); ?> <?php echo $vbo_app->createPopover(array('title' => JText::_('VBTRKAVGCONVRATE'), 'content' => JText::_('VBTRKAVGCONVRATEHELP'))); ?></h5>
			...
			?>
				<div class="vbo-trackings-chart-referrers">
					<h4><?php echo JText::_('VBTRKBESTREFERRERS'); ?></h4>
				<?php
