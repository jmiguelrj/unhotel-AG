...
<div class="vbmodhorsearchmaindiv <?php echo $wrapper_class; ?>">
	<form action="<?php echo JRoute::_('index.php?option=com_vikbooking&task=search&Itemid=' . $params->get('itemid', 0)); ?>" method="post" id="vbo-mod-horsearch-form-<?php echo $randid; ?>">
	...
	?>
		<div class="vbmodhorsearch-hum-dates-wrap">
			<div class="vbmodhorsearch-humcalcont vbmodhorsearchcheckindiv">
				<label class="vbo-horizsearch-lbl-dt-<?php echo $randid; ?>"><?php echo JText::_('VBMCHECKIN'); ?></label>
				<div class="vbo-horizsearch-showcalendar vbo-horizsearch-showcalendar-from" id="vbo-horizsearch-checkin<?php echo $randid; ?>">
					...
					<span class="vbo-horizsearch-placeholder"><?php echo JText::_('HORIZSEARCHPICKDATE'); ?></span>
			...
			<div class="vbmodhorsearch-humcalcont vbmodhorsearchcheckoutdiv">
				<label class="vbo-horizsearch-lbl-dt-<?php echo $randid; ?>"><?php echo JText::_('VBMCHECKOUT'); ?></label>
...
if ($dates_layout_type == 'human') {
	...
	?>
		<div class="vbmodhorsearch-hum-guests-wrap">
			...
			<label onclick="jQuery('#vbmodhorsearch-hum-guests-count<?php echo $randid; ?>').trigger('click');"><?php echo JText::_('VBMHORSGUESTS'); ?></label>
			...
			<div class="vbmodhorsearch-hum-guests-count" id="vbmodhorsearch-hum-guests-count<?php echo $randid; ?>">
				<div class="vbmodhorsearch-hum-guests-elem vbmodhorsearch-hum-guests-rooms"<?php echo intval($maxsearchnumrooms) < 2 ? ' style="display: none;"' : ''; ?>>
					<label><?php echo JText::_('VBMFORMROOMSN'); ?></label>
				...
				<div class="vbmodhorsearch-hum-guests-elem vbmodhorsearch-hum-guests-adults">
					<label><?php echo JText::_($use_guests_label); ?></label>
			...
			if ($showchildren) {
				...
				<div class="vbmodhorsearch-hum-guests-elem vbmodhorsearch-hum-guests-children">
					<label><?php echo JText::_('VBFORMCHILDREN'); ?></label>
			...
			<div class="vbmodhorsearch-hum-guests-modifier" style="display: none;">
				...
				?>
					<div class="vbmodhorsearchroomdentr">
						...
						if (intval($maxsearchnumrooms) > 1) {
							?>
							<span class="horsrnum"><?php echo JText::_('VBMFORMNUMROOM'); ?> 1</span>
							<?php
						}
						?>
							<div class="horsanumdiv">
								<label class="horsanumlb" for="vbo-mhs-adults-<?php echo $randid; ?>"><?php echo JText::_($use_guests_label); ?></label>
								<span class="horsanumsel"><?php echo $adultsel; ?></span>
							</div>
							<?php if ($showchildren): ?>
							<div class="horscnumdiv">
								<label class="horscnumlb" for="vbo-mhs-children-<?php echo $randid; ?>"><?php echo JText::_('VBFORMCHILDREN'); ?></label>
	...
	?>
		<div class="vbmodhorsearchrac">
			...
			<div class="vbmodhorsearchroomsel">
				<?php if (intval($maxsearchnumrooms) > 1): ?><label for="vbmodformroomsn<?php echo $randid; ?>"><?php echo JText::_('VBMFORMROOMSN'); ?></label><?php endif; ?>
				<?php echo $roomsel; ?>
			</div>
...
if (intval($params->get('showcat')) === 1) {
	...
	if ($dbo->getNumRows() > 0) {
		...
		<div class="vbmodhorsearchcategoriesblock">
			<label class="vbmodhscategories" for="vbmodhscategories<?php echo $randid; ?>"><?php echo JText::_('VBMROOMCAT'); ?></label>
...
if ($needs_inquiry) {
	...
	?>
		...
		<div class="vbo-mod-horsearch-inquiry-submit">
			<button type="button" onclick="vboModHorSearchSendRequest(this, '<?php echo $randid; ?>');" class="btn vbsearchinputmodhors vbo-pref-color-btn"><?php echo JText::_('INQ_SEND_REQUESTS') ?></button>
		</div>

		<div class="vbo-mod-horsearch-inquiry-checkav">
			<div class="vbo-mod-horsearch-inquiry-checkav-inner">
				<h4><?php echo JText::_('INQ_OR_BOOK_ONLINE'); ?></h4>
				<div>
					<button type="button" onclick="vboModHorSearchBookOnline('<?php echo $randid; ?>');" class="btn vbsearchinputmodhors vbo-mod-horsearch-checkav-btn"><?php echo JText::_('INQ_CHECK_AVAILABILITY') ?></button>
				</div>
			</div>
		</div>
	<?php
	...
	?>
		<div class="vbmodhorsearchbookdiv">
			<button type="submit" id="vbo-mod-horsearch-sbt-<?php echo $randid; ?>" class="btn vbsearchinputmodhors vbo-pref-color-btn"><?php echo JText::_('SEARCHD'); ?></button>
		</div>

		<script type="text/javascript">
			jQuery(function() {
				jQuery('button#vbo-mod-horsearch-sbt-<?php echo $randid; ?>').on('click', function(e) {
					e.preventDefault();
...
<div class="vbo-modhs-js-helpers" style="display: none;">
	<div class="vbo-modhs-add-element-html">
		<div class="vbmodhorsearchroomdentr">
			<span class="horsrnum"><?php echo JText::_('VBMFORMNUMROOM'); ?> %d</span>
			<div class="horsanumdiv">
				<label style="display: none;" for="vbo-mhs-adults-<?php echo $randid; ?>-hid"><?php echo JText::_($use_guests_label); ?></label>
				<span class="horsanumsel"><?php echo preg_replace("/\sid=\"([a-z0-9\-]+)\"/i", ' id="$1-hid"', $adultsel); ?></span>
			<?php
			if ($showchildren) {
				?>
				<div class="horscnumdiv">
					<label style="display: none;" for="vbo-mhs-children-<?php echo $randid; ?>-hid"><?php echo JText::_('VBFORMCHILDREN'); ?></label>
...
function vbCalcNightsMod<?php echo $randid; ?>() {
	...
	?>
		...
		if (vboutts > vbints) {
			...
			if (vbnights > 0) {
				document.getElementById('vbjstotnightsmod<?php echo $randid; ?>').innerHTML = '<div class="vbo-horizsearch-numnights-inner"><span><?php echo addslashes(JText::_('VBMJSTOTNIGHTS')); ?>:</span> <span>'+vbnights+'</span></div>';
			} else {
