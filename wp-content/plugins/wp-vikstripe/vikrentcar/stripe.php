...
add_action('payment_before_validate_transaction_vikrentcar', function($payment)
{
	// make sure the driver is Stripe
	if (!$payment->isDriver('stripe'))
	{
 ...
 * @since 1.0
 */
class VikRentCarStripePayment extends AbstractStripePayment
{
	/**
	 * @override
	 * Class constructor.
	...
	public function __construct($alias, $order, $params = array())
	{
		...
		$customer = VikRentCar::getCPinIstance()->getCustomerFromBooking($this->get('oid'));
