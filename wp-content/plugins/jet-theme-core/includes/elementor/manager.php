...
class Manager {
	...
	public function editor_scripts() {
		...
		wp_localize_script( 'jet-theme-core-editor', 'JetThemeCoreData', apply_filters(
			...
			array(
				...
				'editorNonce' => wp_create_nonce( 'jet-theme-core-elementor-editor-nonce' ),
			)
		) );
	}
	 ...
	 * @return array|object
	 */
	public function structure_template_details( $template_details, $template_id, $type, $content_type ) {
		$additional = [];

		if ( 'elementor' === $content_type ) {
			$additional[] = 'elementor-editor';
		}
