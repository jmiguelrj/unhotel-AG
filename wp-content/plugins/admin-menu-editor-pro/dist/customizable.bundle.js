"use strict";
(self["wsAmeWebpackChunk"] = self["wsAmeWebpackChunk"] || []).push([["customizable"],{

/***/ "./extras/pro-customizables/assets/customizable.js":
/*!*********************************************************!*\
  !*** ./extras/pro-customizables/assets/customizable.js ***!
  \*********************************************************/
...
/* harmony export */   AmeCustomizable: () => (/* binding */ AmeCustomizable),
/* harmony export */   AmeCustomizableViewModel: () => (/* binding */ AmeCustomizableViewModel)
/* harmony export */ });
...
(function (AmeCustomizable) {
    ...
    class SettingCollection {
        ...
        add(setting) {
            ...
            this.valueSubscriptions[setting.id] = setting.value.subscribe((newValue) => this.onSettingChanged(setting, newValue));
        }
        remove(settingId) {
    ...
    class Container extends UiElement {
        constructor(data, children = [], registry) {
    ...
    class ControlGroup extends Container {
        constructor(data, registry, children = [], enabled = null) {
            if (!data.component) {
    ...
    class Control extends UiElement {
        constructor(data, settings = {}, registry, enabled = null, children = []) {
            super(data, registry, children);
         ...
         */
        createControlGroup(groupComponent) {
    ...
    class ForEachBlock extends UiElement {
        constructor(data, registry, children = []) {
            super(data, registry, children);
        }
    }
    AmeCustomizable.ForEachBlock = ForEachBlock;
    function unserializeUiElement(data, findSetting, registry, dataCustomizer) {
        ...
        if ((typeof dataAsRecord['children'] !== 'undefined') && Array.isArray(dataAsRecord['children'])) {
            for (const childData of dataAsRecord['children']) {
                children.push(unserializeUiElement(childData, findSetting, registry, dataCustomizer));
            }
        }
        ...
        switch (data.t) {
            case 'section':
                return new Section(data, registry, children);
            case 'control-group':
                return new ControlGroup(data, registry, children, enabled);
            case 'structure':
                return new InterfaceStructure(data, registry, children);
            case 'control':
                let settings = {};
                if (data.settings) {
                ...
                return new Control(data, settings, registry, enabled, children);
            case 'foreach':
                return new ForEachBlock(data, registry, children);
            default:
...
(function (AmeCustomizableViewModel) {
    ...
    class SimpleVm extends ThrottledPreviewRegistry {
        ...
        getSettingObservable(settingId, _unusedDefaultValue = null) {
...
//# sourceMappingURL=customizable.bundle.js.map