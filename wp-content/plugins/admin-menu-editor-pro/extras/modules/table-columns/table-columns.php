...
class TableColumnsModule extends amePersistentProModule implements ameExportableModule {
	...
	public function enqueueTabScripts() {
		...
		if ( $this->shouldRefreshTables ) {
			...
			//Editor mode.
			$script = $this->createScriptDependency('table-columns.js')
				->deps('jquery', $baseDeps['ame-pro-common-lib'])
			...
			$script
				->addJsVariable(
					...
					[
						...
						'saveFormConfig'           => $this->getSaveFormHandler()->getJsSaveFormConfig(),
	...
	public function handleSettingsForm($post = array()) {
		...
		$formSubmission = $this->getSaveFormHandler()->processKnockoutSubmission($post);
	...
	/**
	 * @return KnockoutSaveForm
	 */
	private function getSaveFormHandler(): KnockoutSaveForm {
