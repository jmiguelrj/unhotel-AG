...
/**
 * A tweak that unregisters all[^1] block patterns.
 *
 * [^1]: The current implementation doesn't unregister user-created reusable blocks, which also
 * show up as patterns in the block editor.
 */
