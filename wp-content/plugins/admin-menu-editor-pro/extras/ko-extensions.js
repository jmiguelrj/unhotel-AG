...
class AmeCollapsibleStateStore {
    constructor(preferenceName, cookiePath, overrideCookieName = null) {
        this.registeredCollapsibles = new Map();
        this.storedState = ko.observable({});
        this.hasStoredState = false;
        this.cookie = new WsAmePreferenceCookie(preferenceName, 90, true, cookiePath, overrideCookieName);
    ...
    getOrCreateObservable(id, openByDefault = true) {
