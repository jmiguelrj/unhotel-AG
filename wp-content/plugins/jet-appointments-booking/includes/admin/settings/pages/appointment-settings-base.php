...
class Appointment_Settings_Base extends Page_Module_Base {
	...
	public function page_settings() {
		...
		$page_config_args['nonce'] = wp_create_nonce( Plugin::instance()->settings->nonce_key() );

		$page_config_args['timezones_list'] = timezone_identifiers_list();
	...
	public function enqueue_module_assets() {
		...
		wp_enqueue_style( 'jet-apb-layout' );
	}
