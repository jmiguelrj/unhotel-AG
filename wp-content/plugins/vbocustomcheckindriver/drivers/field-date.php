...
final class VBOCheckinPaxfieldTypeCustomDate extends VBOCheckinPaxfieldType {
    public function render() {
        ...
        $out = '<input type="text" id="'.$id.'" name="'.$name.'" value="'.$val.'" placeholder="'.$placeholder.'" class="vbo-cid-input vbo-cid-date" inputmode="numeric" />';
