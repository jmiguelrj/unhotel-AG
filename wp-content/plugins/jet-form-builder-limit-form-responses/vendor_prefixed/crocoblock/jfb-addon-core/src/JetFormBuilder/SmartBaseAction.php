...
abstract class SmartBaseAction extends Base
{
    ...
    {
        return \array_merge($this->getSettings(), $this->global_settings($this->getGlobalSettingsKeys()));
    }
    ...
    public function do_action(array $request, Action_Handler $handler)
    {
        try {
            ...
            throw new Action_Exception($this->parseDynamicException($exception->type(), $exception->getMessage()), ...$exception->getAdditional());
        }
    }
