...
trait FormFieldLocalize
{
     ...
     * @return string
     */
    public abstract function handler_for_localize();
    public function maybe_localize_block_data()
    {
        $prepared = array();
        $methods = array(array('name' => 'editor_labels', 'prop' => '__labels'), array('name' => 'editor_help', 'prop' => '__help'), array('name' => 'editor_data'));
