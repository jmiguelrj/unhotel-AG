...
trait RegisterMetaManager
{
    ...
    public abstract function meta_data();
    public final function _register_meta()
    {
        ...
        foreach ($meta_data as $meta_key => $meta_params) {
            register_meta('post', $meta_key, \array_merge(['single' => \true, 'type' => 'string', 'show_in_rest' => \true, 'auth_callback' => [$this, 'auth_callback'], 'sanitize_callback' => [$this, 'sanitize_callback']], $meta_params));
        }
    }
