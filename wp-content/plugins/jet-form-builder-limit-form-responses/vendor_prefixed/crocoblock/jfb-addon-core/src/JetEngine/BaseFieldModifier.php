...
use JFB\LimitResponses\Vendor\JFBCore\FieldModifierIT;
use JFB\LimitResponses\Vendor\JFBCore\FieldModifierTrait;
use JFB\LimitResponses\Vendor\JFBCore\VueComponentProps;
abstract class BaseFieldModifier implements FieldModifierIT
{
    ...
    {
        add_filter("jet-engine/forms/render/{$this->type()}", array($this, 'renderHandler'), 10, 2);
        add_action('jet-engine/forms/edit-field/before', array($this, 'renderFieldControls'));
        add_action('jet-engine/forms/editor/assets', array($this, 'editorAssets'));
    }
