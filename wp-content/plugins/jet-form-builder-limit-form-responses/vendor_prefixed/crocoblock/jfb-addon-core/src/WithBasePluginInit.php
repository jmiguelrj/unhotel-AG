...
trait WithBasePluginInit
{
    ...
    public abstract function base_condition() : bool;
    public final function plugin_maybe_init()
    {
    ...
    public abstract function plugin_version_compare() : string;
    public abstract function can_init() : bool;
    public abstract function on_plugin_init();
    /**
