...
trait BaseRenderField
{
    ...
    public abstract function render_field($attrs_string);
    /**
     ...
     * @param string $name
     */
    public abstract function get_field_name($name = '');
    public abstract function get_required_val();
    public abstract function get_field_id();
    /**
     * Base function, it must rewrite on core-level
     */
    public abstract function main_field_class();
    /**
     * Base function, it must rewrite on core-level
     *
     * @param $custom_label
     * @param $custom_mark
     */
    public abstract function include_field_label($custom_label = \false, $custom_mark = \false);
    /**
     * Base function, it must rewrite on core-level
     *
     * @param $custom_desc
     */
    public abstract function include_field_desc($custom_desc = \false);
    /**
     * Base function, it must rewrite on core-level
     */
    public abstract function include_layout_column();
    /**
     * Base function, it must rewrite on core-level
     */
    public abstract function include_layout_row();
    /**
     * Base function, it must rewrite on core-level
     */
    public abstract function get_layout_arg();
    /**
     * Base function, it must rewrite on core-level
     *
     * @param $template
     ...
     * @return false|string
     */
    public final function include_layout($template, $additional = array())
    {
    ...
    public final function get_arg($key, $if_not_exist = '')
    {
    ...
    public final function get_attributes_map()
    {
     ...
     * @return string
     */
    public final function get_rendered()
    {
