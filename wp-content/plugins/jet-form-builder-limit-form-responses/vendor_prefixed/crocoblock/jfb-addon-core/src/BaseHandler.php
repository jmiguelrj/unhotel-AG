...
use JFB\LimitResponses\Vendor\JFBCore\Exceptions\ApiHandlerException;
abstract class BaseHandler
{
    ...
    {
        return array('api_key' => array('sanitize_func' => 'sanitize_text_field'));
    }
    ...
    public abstract function ajax_action() : string;
    public abstract function get_all_data();
    ...
    {
        return \array_merge(array('message' => $exception->getMessage()), $exception->getAdditional());
    }
