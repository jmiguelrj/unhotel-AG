...
class VikChannelManagerViewGooglevrmnglisting extends JViewUI
{
    ...
    protected function addToolBar()
    {
        ...
        if (!empty($idroomota)) {
            // edit
            JToolBarHelper::title('Google Vacation Rentals - ' . JText::_('VCM_MNGLISTING_EDIT'), 'vikchannelmanager');
            if (JFactory::getUser()->authorise('core.edit', 'com_vikchannelmanager')) {
                JToolBarHelper::apply('googlevrlst.updatelisting_stay', JText::_('SAVE'));
                JToolBarHelper::save('googlevrlst.updatelisting', JText::_('SAVECLOSE'));
                JToolBarHelper::spacer();
            }
            JToolBarHelper::cancel('googlevrlst.cancel', JText::_('BACK'));
            JToolBarHelper::spacer();
        } else {
            // new
            JToolBarHelper::title('Google Vacation Rentals - ' . JText::_('VCM_MNGLISTING_NEW'), 'vikchannelmanager');
            JToolBarHelper::cancel('googlevrlst.cancel', JText::_('BACK'));
            JToolBarHelper::spacer();
        }
    }
