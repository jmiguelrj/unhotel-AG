...
/**
 * VikChannelManager ACL view.
 *
 * @since 1.0
 */
class VikChannelManagerViewAcl extends JView
{
	/**
	 * @override
	 * View display method.
	...
	public function display($tpl = null)
	{
		...
		if (!$user->authorise('core.admin', 'com_vikchannelmanager'))
		{
			wp_die(
	...
	{
		JToolbarHelper::title('Vik Channel Manager - Access Control List');
