		...
		<div class="vcm-revscore-info">
			<div class="vcm-revscore-score-wrap">
				...
				<div class="vcm-revscore-score-totrev">
					<span><?php echo JText::sprintf('VCMREVBASEDONTOT', (isset($score_content->review_score) ? $score_content->review_score->count : 0)); ?></span>
				</div>
			</div>
		</div>
	</div>
		...
		foreach ($score_content as $category => $score) {
			...
			<div class="vcm-revscore-subscore">
				<div class="vcm-revscore-subscore-inner">
					...
					<div class="vcm-revscore-subscore-point"><?php echo round($score->rating, 1); ?></div>
				</div>
