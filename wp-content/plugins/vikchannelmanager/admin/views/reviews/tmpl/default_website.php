...
<div class="vcm-revscore-container">
	...
	<div class="vcm-revscore-info-top">
		...
		<?php
		if (!empty($this->glob_score['prop_name'])) {
			?>
		...
		<div class="vcm-revscore-info">
			<div class="vcm-revscore-logo">
				<span class="vcm-revscore-logo-website"><?php echo JText::_('VCMWEBSITE'); ?></span>
			</div>
		</div>
		<div class="vcm-revscore-info">
			<div class="vcm-revscore-score-wrap">
				<div class="vcm-revscore-score-point vcm-revscore-score-point-website">
