...
class VikChannelManagerViewrevexpress extends JViewUI {
	...
	function display($tpl = null) {
		...
		$_url = 'https://api.tripadvisor.com/api/partner/1.0/email_requests?location_id='.$partner_id.'&key='.$tac_api_key;
