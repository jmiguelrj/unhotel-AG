		...
		if($tot_rate_plans > 0) {
			foreach($rooms[0]['RatePlan'] as $rateplan) {
				...
				if (array_key_exists('Rate', $rateplan) && count($rateplan['Rate']) > 0) {
					...
					//Double Occupancy
					if($inventory_loaded === false && (array_key_exists('RoomInfo', $ota_rate_plan) && array_key_exists('num_persons', $ota_rate_plan['RoomInfo']) && $ota_rate_plan['RoomInfo']['num_persons'] < 2)) {
					...
					//Full Rate
					if($inventory_loaded === false && (array_key_exists('RoomInfo', $ota_rate_plan) && array_key_exists('num_persons', $ota_rate_plan['RoomInfo']) && $ota_rate_plan['RoomInfo']['num_persons'] < 3)) {
