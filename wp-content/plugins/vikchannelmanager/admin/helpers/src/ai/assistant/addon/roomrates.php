...
/**
 * AI assistant message room rates add-on.
 * 
 * @since 1.9
 */
class VCMAiAssistantAddonRoomrates implements VCMAiAssistantAddon
{
    /** @var JDate */
    protected $checkin;
    ...
    public function render(VCMAiAssistantRenderer $renderer)
    {
        foreach ($this->roomNames as $roomName) {
            $html = '<span class="label label-info">' . JText::_('VBO_AITOOL_ROOM_RATES') . '</span>' . "\n"
