		...
		public function add_style_manager_options() {
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'separator'    => 'before',
					'css_selector' => [
						$this->css_selector( '.jet-woo-product-gallery-slider.swiper-container-vertical' ) => 'height: {{VALUE}}{{UNIT}};',
					],
					'condition'    => [
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'css_selector' => [
						$this->css_selector( $this->css_scheme['images'] ) => 'padding: {{TOP}} {{RIGHT}} {{BOTTOM}} {{LEFT}};',
					],
				]
			);
			...
			$this->controls_manager->start_tab(
				...
				[
					...
					'title' => __( 'Active', 'jet-woo-product-gallery' ),
				]
			);
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'css_selector' => [
						...
						$this->css_selector( '.jet-woo-swiper-vertical .jet-gallery-swiper-slider' ) => 'max-width: calc(100% - {{VALUE}}{{UNIT}});',
					],
					'condition'    => [
						'slider_pagination_direction' => 'vertical',
					],
			...
			$this->controls_manager->start_tabs(
				'style_controls',
				[ 'id' => 'tabs_thumbnails_style' ]
			);

			$this->controls_manager->start_tab(
				'style_controls',
				[
					'id'    => 'tabs_thumbnails_normal',
					'title' => __( 'Normal', 'jet-woo-product-gallery' ),
				]
			);
			...
			$this->controls_manager->add_control(
				[
					...
					'css_selector' => [
						$this->css_selector( $this->css_scheme['thumbnails-slide'] ) => 'opacity: {{VALUE}};',
					]
				]
			);
			...
			$this->controls_manager->add_control(
				[
					...
					'css_selector' => [
						$this->css_selector( $this->css_scheme['thumbnails-slide'] . ':hover' ) => 'opacity: {{VALUE}};',
					]
				]
			);
			...
			$this->controls_manager->add_control(
				[
					...
					'css_selector' => [
						$this->css_selector( $this->css_scheme['thumbnails-slide'] . '.swiper-slide-thumb-active' ) => 'opacity: {{VALUE}};',
					]
				]
			);
