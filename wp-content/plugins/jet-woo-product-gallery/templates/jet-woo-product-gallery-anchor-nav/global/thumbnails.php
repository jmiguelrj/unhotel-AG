...
$controller_id = $this->get_unique_controller_id();

array_push( $anchor_nav_controller_ids, $controller_id );
?>

<div class="jet-woo-product-gallery__image-item" id="<?php echo esc_attr( $controller_id ); ?>">
	<div class="jet-woo-product-gallery__image<?php echo esc_attr( $zoom_class ); ?>">
		<?php
		...
		printf( '<a %s>%s</a>', jet_woo_product_gallery_tools()->implode_html_attributes( $link_attrs ), wp_kses_post( $image ) );
		?>
	</div>
</div>
