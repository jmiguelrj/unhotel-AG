...
if( !function_exists('homey_get_localization')) {
	function homey_get_localization() {
		...
		$localization = array(
			...
			'add_favorite'    	=> esc_html__('Add to Favorite', 'homey'),
			...
			'agree_term_text' => esc_html__('You need to agree with terms and condition', 'homey'),
			...
			'drag_drop_img' => wp_kses(__( 'Drag and drop the images to customize the gallery order.<br>Click on the star icon to set the featured image', 'homey' ), $allowed_html_array),
			...
			'ins_notic' => esc_html__('Please act quickly! Rates and availability may subject to change.', 'homey'),
			...
			*------------------------------------------------------*/
			...
			'period_name_label' => esc_html__('Period name', 'homey'),
			'period_name_plac' => esc_html__('Enter the period name', 'homey'),

			'night_minimum_label' => esc_html__('Minimum of Nights', 'homey'),
			'night_minimum_plac' => esc_html__('Enter the minimum of nights for the period', 'homey'),

			'min_book_custom_period_days_error' => esc_html__('%s: minimum booking days are %s for the period %s to %s', 'homey'),

			'package_label' => esc_html__('Package', 'homey'),
		);
