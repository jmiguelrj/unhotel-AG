...
<div class="row">
    <div class="col-xs-12">
        <div class="form-group">
            <label><?php echo esc_attr($homey_local['period_name_label']); ?></label>
            <input type="text" name="cus_period_name" id="cus_period_name" class="form-control" placeholder="<?php echo esc_attr($homey_local['period_name_plac']); ?>">
        </div>
    </div>
</div>
...
<?php } ?>
    ...
    <div class="col-sm-6 col-xs-12">
        <div class="form-group">
            <label><?php echo esc_attr($homey_local['night_minimum_label']); ?></label>
            <input type="text" name="cus_night_minimum" id="cus_night_minimum" class="form-control" placeholder="<?php echo esc_attr($homey_local['night_minimum_plac']); ?>">
        </div>
    </div>
...
<div class="table-block dashboard-reservation-table dashboard-table">
    <table class="table table-hover">
        <thead>
            <tr>
                <th><?php echo esc_attr($homey_local['period_name_label']); ?></th>
                ...
                <?php } ?>
                <th><?php echo esc_attr($homey_local['night_minimum_label']); ?></th>
